...
describe("data", "bson", "Decimal128", () => {
    ...
    it("Serialize and Deserialize tests", (done) => {
        ...
        let buffer = bson2.encode(doc);
        let size = bson2.calculateObjectSize(doc);
        let back = bson2.decode(buffer);
        ...
        buffer = bson2.encode(doc);
        size = bson2.calculateObjectSize(doc);
        back = bson2.decode(buffer);
    ...
    it("Support toBSON and toObject methods for custom mapping", (done) => {
        ...
        const buffer = bson2.encode(doc);
        const back = bson2.decode(buffer);
