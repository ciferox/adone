...
describe("Map", () => {
    ...
    it("should serialize a map", (done) => {
        ...
        let m = new M([["a", 1], ["b", 2]]);
        // Serialize the map
        let data = bson2.encode(m, false, true);
        // Deserialize the data
        let object = bson2.decode(data);
        ...
        m = new M([["c", m1]]);
        // Serialize the map
        data = bson2.encode(m, false, true);
        // Deserialize the data
        object = bson2.decode(data);
    ...
    it("should not crash due to object that looks like map", (done) => {
        ...
        // Serialize the map
        const data = bson2.encode(m, false, true);
        // Deserialize the data
        const object = bson2.decode(data);
