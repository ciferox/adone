...
describe("data", "bson", "BSON", () => {
    ...
    it("Should Correctly Deserialize object with all types", (done) => {
        ...
        const object = bson2.decode(new Buffer(serializedData, "binary"));
        // Perform tests
    ...
    it("Should Serialize and Deserialize String", (done) => {
        ...
        const serializedData = bson2.encode(test_string, {
            checkKeys: false
        });

        bson2.encodeWithBufferAndIndex(test_string, serializedData, {
            checkKeys: false,
            index: 0
        });

        expect(test_string).to.deep.equal(bson2.decode(serializedData));
        done();
    });
    ...
    it("Should Serialize and Deserialize Empty String", (done) => {
        ...
        const serializedData = bson2.encode(test_string);
        const serializedData2 = new Buffer(bson2.calculateObjectSize(test_string));
        bson2.encodeWithBufferAndIndex(test_string, serializedData2);
    ...
    it("Should Correctly Serialize and Deserialize Integer", (done) => {
        ...
        const serializedData = bson2.encode(test_number);
        const serializedData2 = new Buffer(bson2.calculateObjectSize(test_number));
        bson2.encodeWithBufferAndIndex(test_number, serializedData2);
        assertBuffersEqual(done, serializedData, serializedData2, 0);
        expect(test_number).to.deep.equal(bson2.decode(serializedData));
        expect(test_number).to.deep.equal(bson2.decode(serializedData2));
        done();
    });
    ...
    it("Should Correctly Serialize and Deserialize null value", (done) => {
        ...
        const serializedData = bson2.encode(test_null);

        const serializedData2 = new Buffer(bson2.calculateObjectSize(test_null));
        bson2.encodeWithBufferAndIndex(test_null, serializedData2);
        assertBuffersEqual(done, serializedData, serializedData2, 0);

        const object = bson2.decode(serializedData);
    ...
    it("Should Correctly Serialize and Deserialize Integer", (done) => {
        let test_int = { doc: 42 };
        let serializedData = bson2.encode(test_int);

        let serializedData2 = new Buffer(bson2.calculateObjectSize(test_int));
        bson2.encodeWithBufferAndIndex(test_int, serializedData2);
        assertBuffersEqual(done, serializedData, serializedData2, 0);
        expect(test_int.doc).to.deep.equal(bson2.decode(serializedData).doc);

        test_int = { doc: -5600 };
        serializedData = bson2.encode(test_int);

        serializedData2 = new Buffer(bson2.calculateObjectSize(test_int));
        bson2.encodeWithBufferAndIndex(test_int, serializedData2);
        assertBuffersEqual(done, serializedData, serializedData2, 0);
        expect(test_int.doc).to.deep.equal(bson2.decode(serializedData).doc);
    ...
    it("Should Correctly Serialize and Deserialize Object", (done) => {
        ...
        const serializedData = bson2.encode(doc);

        const serializedData2 = Buffer.alloc(bson2.calculateObjectSize(doc));
        bson2.encodeWithBufferAndIndex(doc, serializedData2);
        assertBuffersEqual(done, serializedData, serializedData2, 0);

        expect(doc.doc.age).to.deep.equal(bson2.decode(serializedData).doc.age);
        expect(doc.doc.name).to.deep.equal(bson2.decode(serializedData).doc.name);
        expect(doc.doc.shoe_size).to.deep.equal(bson2.decode(serializedData).doc.shoe_size);
    ...
    it("Should correctly ignore undefined values in arrays", (done) => {
        ...
        const serializedData2 = new Buffer(
            bson2.calculateObjectSize(doc, {
                ignoreUndefined: true
            })
        );
        bson2.encodeWithBufferAndIndex(doc, serializedData2, {
        ...
        assertBuffersEqual(done, serializedData, serializedData2, 0);
        const doc1 = bson2.decode(serializedData);
    ...
    it("Should correctly serialize undefined array entries as undefined values", (done) => {
        ...
        assertBuffersEqual(done, serializedData, serializedData2, 0);
        const doc1 = bson2.decode(serializedData);
        const doc2 = bson2.decode(serializedData2);
        // console.log("======================================== 0")
        // console.dir(doc1)
        // console.dir(doc2)
    ...
    it("Should Correctly Serialize and Deserialize Array", (done) => {
        ...
        const deserialized = bson2.decode(serializedData);
    ...
    it("Should Correctly Serialize and Deserialize Number 4", (done) => {
        const doc = { doc: bson2.BSON_INT32_MAX + 10 };
        const serializedData = bson2.encode(doc);
        ...
        const deserialized = bson2.decode(serializedData);
        // expect(deserialized.doc instanceof Binary).to.be.ok;
        expect(bson2.BSON_INT32_MAX + 10).to.equal(deserialized.doc);
        done();
    });
    ...
    it("Should correctly deserialize a nested object", (done) => {
        ...
        expect(doc.doc.doc).to.deep.equal(bson2.decode(serializedData).doc.doc);
        done();
    });
    ...
    it("Should Correctly Serialize and Deserialize A Boolean", (done) => {
        ...
        expect(doc.doc).to.equal(bson2.decode(serializedData).doc);
        done();
    });
    ...
    it("Should Correctly Serialize and Deserialize a Date from another VM", (done) => {
        ...
        bson2.encodeWithBufferAndIndex(doc, serializedData2);
        assertBuffersEqual(done, serializedData, serializedData2, 0);
        expect(doc.date).to.equal(bson2.decode(serializedData).doc.date);
        done();
    });
    ...
    it("Should Correctly Serialize and Deserialize Oid", (done) => {
        ...
        expect(doc).to.deep.equal(bson2.decode(serializedData));
        done();
    });
    ...
    it("Should Correctly Serialize and Deserialize Ordered Hash", (done) => {
        ...
        const decoded_hash = bson2.decode(serializedData).doc;
        const keys = [];
    ...
    it("Should Correctly Serialize and Deserialize Regular Expression", (done) => {
        ...
        const doc2 = bson2.decode(serializedData);
    ...
    it("Should Correctly Serialize and Deserialize a Binary object", (done) => {
        ...
        const deserializedData = bson2.decode(serializedData);
    ...
    it("Should Correctly Serialize and Deserialize DBRef", (done) => {
        ...
        const serializedData = b.encode(doc);
        const serializedData2 = Buffer.alloc(b.calculateObjectSize(doc));
        b.encodeWithBufferAndIndex(doc, serializedData2);
        expect(serializedData).to.deep.equal(serializedData2);

        const doc2 = b.decode(serializedData);
    ...
    it("Should Correctly Serialize and Deserialize Long Integer", (done) => {
        ...
        let serializedData = bson2.encode(doc);

        const serializedData2 = Buffer.alloc(bson2.calculateObjectSize(doc));
        bson2.encodeWithBufferAndIndex(doc, serializedData2);
        assertBuffersEqual(done, serializedData, serializedData2, 0);

        let deserializedData = bson2.decode(serializedData);
        expect(doc.doc).to.deep.equal(deserializedData.doc);

        doc = { doc: Long.fromNumber(-9223372036854775) };
        serializedData = bson2.encode(doc);
        deserializedData = bson2.decode(serializedData);
        expect(doc.doc).to.deep.equal(deserializedData.doc);
    ...
    it("Should Correctly Serialize and Deserialize Timestamp as subclass of Long", (done) => {
        ...
        const serializedData = bson2.encode(test_int);

        const serializedData2 = new Buffer(bson2.calculateObjectSize(test_int));
        bson2.encodeWithBufferAndIndex(test_int, serializedData2);
        assertBuffersEqual(done, serializedData, serializedData2, 0);

        const deserializedData = bson2.decode(serializedData);
        expect(test_int.doc).to.deep.equal(deserializedData.doc);
        done();
    });

    it("Should Always put the id as the first item in a hash", (done) => {
        const hash = { doc: { not_id: 1, _id: 2 } };
        const serializedData = bson2.encode(hash);

        const serializedData2 = new Buffer(bson2.calculateObjectSize(hash));
        bson2.encodeWithBufferAndIndex(hash, serializedData2);
        assertBuffersEqual(done, serializedData, serializedData2, 0);
    ...
    it("Should Correctly Serialize and Deserialize a User defined Binary object", (done) => {
        const bin = new Binary();
        bin.sub_type = bson2.BSON_BINARY_SUBTYPE_USER_DEFINED;
        const string = "binstring";
        for (let index = 0; index < string.length; index++) {
            bin.put(string.charAt(index));
        }
        ...
        expect(deserializedData.doc.sub_type).to.deep.equal(bson2.BSON_BINARY_SUBTYPE_USER_DEFINED);
        expect(doc.doc.value()).to.deep.equal(deserializedData.doc.value());
        done();
    });
    ...
    it("Should handle complicated all typed object", (done) => {
        ...
        let serializedData2 = Buffer.alloc(bson2.calculateObjectSize(doc));
        bson2.encodeWithBufferAndIndex(doc, serializedData2);

        expect(serializedData).to.deep.equal(serializedData2);

        serializedData2 = bson2.encode(doc2, false, true);
    ...
    it("Should correctly massive doc", (done) => {
        ...
        const serializedData = b.encode(doc);
        let serializedData2 = Buffer.alloc(b.calculateObjectSize(doc));
        b.encodeWithBufferAndIndex(doc, serializedData2);
        expect(serializedData).to.deep.equal(serializedData2);

        serializedData2 = b.encode(doc2, false, true);
        expect(serializedData).to.deep.equal(serializedData2);
        done();
    });
    ...
    it("Should Correctly Serialize/Deserialize regexp object", (done) => {
        ...
        serializedData2 = bson2.encode(doc);
    ...
    /**
     * A simple example showing the usage of bson2.calculateObjectSize function returning the number of BSON bytes a javascript object needs.
     *
     * @_class bson
     * @_function bson2.calculateObjectSize
     * @ignore
     */
    ...
    /**
     * A simple example showing the usage of bson2.encodeWithBufferAndIndex function.
     *
     * @_class bson
     * @_function bson2.encodeWithBufferAndIndex
     * @ignore
     */
    ...
    /**
     * A simple example showing the usage of bson2.encode function returning serialized BSON Buffer object.
     *
     * @_class bson
     * @_function bson2.encode
     * @ignore
     */
    ...
    // /**
    //  * A simple example showing the usage of bson2.decode function returning a deserialized Javascript function.
    //  *
    //  * @_class bson
    //  * @_function bson2.decode
    //  * @ignore
    //  */
    ...
    //   var bson = bson2;
    //   // Serialize the object to a buffer, checking keys and serializing functions
    //   var buffer = bson.encode(doc, true, true, true);
    //   // Validate the correctness
    //   expect(65).to.equal(buffer.length);
    //
    //   // Deserialize the object with no eval for the functions
    ...
    // /**
    //  * A simple example showing the usage of bson2.deserializeStream function returning deserialized Javascript objects.
    //  *
    //  * @_class bson
    //  * @_function bson2.deserializeStream
    //  * @ignore
    //  */
    ...
    it("Should correctly serialize the BSONRegExp type", (done) => {
        ...
        doc1 = bson2.decode(serializedData);
    ...
    it("Should correctly deserialize the BSONRegExp type", (done) => {
        ...
        const doc1 = bson2.decode(serializedData, { bsonRegExp: true });
