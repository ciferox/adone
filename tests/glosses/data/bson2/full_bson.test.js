...
describe("data", "bson", "Full BSON", () => {
    ...
    it("Should Serialize and Deserialize String", (done) => {
        ...
        const serializedData = bson2.encode(testString);
        expect(testString).to.deep.equal(bson2.decode(serializedData));
        done();
    });
    ...
    it("Should Correctly Serialize and Deserialize undefined value", (done) => {
        ...
        const serializedData = bson2.encode(test_undefined);
    ...
    it("Should Correctly Serialize and Deserialize Integer", (done) => {
        let testInt = { doc: 42 };
        let serializedData = bson2.encode(testInt);
        expect(testInt).to.deep.equal(bson2.decode(serializedData));

        testInt = { doc: -5600 };
        serializedData = bson2.encode(testInt);
        expect(testInt).to.deep.equal(bson2.decode(serializedData));
    ...
    it("Should Correctly Serialize and Deserialize Oid", (done) => {
        ...
        expect(doc.doc.toHexString()).to.deep.equal(
            bson2.decode(serializedData).doc.toHexString()
        );
    ...
    it("Should Correctly Serialize and Deserialize Buffer", (done) => {
        ...
        expect("123451234512345").to.equal(
            bson2.decode(serializedData).doc.buffer.toString("ascii")
        );
    ...
    it("Should Correctly Serialize and Deserialize Buffer with promoteBuffers option", (done) => {
        ...
        expect("123451234512345").to.equal(
            bson2.decode(serializedData, options).doc.toString("ascii")
        );
    ...
    it("Should Correctly encode Empty Hash", (done) => {
        const testCode = {};
        const serializedData = bson2.encode(testCode);
        expect(testCode).to.deep.equal(bson2.decode(serializedData));
        done();
    });
    ...
    it("Should Correctly Serialize and Deserialize Ordered Hash", (done) => {
        ...
        const serializedData = bson2.encode(doc);
        const decodedHash = bson2.decode(serializedData).doc;
        const keys = [];
    ...
    it("Should Correctly Serialize and Deserialize a Binary object", (done) => {
        ...
        const doc = { doc: bin };
        const serializedData = bson2.encode(doc);
        const deserialized_data = bson2.decode(serializedData);
