describe("crypto", "pkcs1", () => {
    ...
    const decodeBase64PublicKey = (modulus, exponent) => {
        ...
        return pki.rsa.setPublicKey(modulus, exponent);
    };

    const decodeBase64PrivateKey = (modulus, exponent, d, p, q, dP, dQ, qInv) => {
        modulus = _base64ToBn(modulus);
        exponent = _base64ToBn(exponent);
        d = _base64ToBn(d);
        p = _base64ToBn(p);
        ...
        return pki.rsa.setPrivateKey(modulus, exponent, d, p, q, dP, dQ, qInv);
    };
    ...
    const testOAEPSHA256 = () => {
        let examples;

        // Example 1: A 1024-bit RSA Key Pair
        // Components of the RSA Key Pair
        let modulus = "qLOyhK+OtQs4cDSoYPFGxJGfMYdjzWxVmMiuSBGh4KvEx+CwgtaTpef87Wdc9GaFEncsDLxkp0LGxjD1M8jMcvYq6DPEC/JYQumEu3i9v5fAEH1VvbZi9cTg+rmEXLUUjvc5LdOq/5OuHmtme7PUJHYW1PW6ENTP0ibeiNOfFvs=";
        let exponent = "AQAB";
        let d = "UzOc/befyEZqZVxzFqyoXFX9j23YmP2vEZUX709S6P2OJY35P+4YD6DkqylpPNg7FSpVPUrE0YEri5+lrw5/Vf5zBN9BVwkm8zEfFcTWWnMsSDEW7j09LQrzVJrZv3y/t4rYhPhNW+sEck3HNpsx3vN9DPU56c/N095lNynq1dE=";
        let p = "0yc35yZ//hNBstXA0VCoG1hvsxMr7S+NUmKGSpy58wrzi+RIWY1BOhcu+4AsIazxwRxSDC8mpHHcrSEurHyjnQ==";
        let q = "zIhT0dVNpjD6wAT0cfKBx7iYLYIkpJDtvrM9Pj1cyTxHZXA9HdeRZC8fEWoN2FK+JBmyr3K/6aAw6GCwKItddw==";
        let dP = "DhK/FxjpzvVZm6HDiC/oBGqQh07vzo8szCDk8nQfsKM6OEiuyckwX77L0tdoGZZ9RnGsxkMeQDeWjbN4eOaVwQ==";
        let dQ = "lSl7D5Wi+mfQBwfWCd/U/AXIna/C721upVvsdx6jM3NNklHnkILs2oZu/vE8RZ4aYxOGt+NUyJn18RLKhdcVgw==";
        let qInv = "T0VsUCSTvcDtKrdWo6btTWc1Kml9QhbpMhKxJ6Y9VBHOb6mNXb79cyY+NygUJ0OBgWbtfdY2h90qjKHS9PvY4Q==";
        let pubkey = decodeBase64PublicKey(modulus, exponent);
        let privateKey = decodeBase64PrivateKey(modulus, exponent, d, p, q, dP, dQ, qInv);
    ...
    const makeKey = () => {
        // Example 1: A 1024-bit RSA Key Pair
        const modulus = "qLOyhK+OtQs4cDSoYPFGxJGfMYdjzWxVmMiuSBGh4KvEx+CwgtaTpef87Wdc9GaFEncsDLxkp0LGxjD1M8jMcvYq6DPEC/JYQumEu3i9v5fAEH1VvbZi9cTg+rmEXLUUjvc5LdOq/5OuHmtme7PUJHYW1PW6ENTP0ibeiNOfFvs=";
        const exponent = "AQAB";
        const d = "UzOc/befyEZqZVxzFqyoXFX9j23YmP2vEZUX709S6P2OJY35P+4YD6DkqylpPNg7FSpVPUrE0YEri5+lrw5/Vf5zBN9BVwkm8zEfFcTWWnMsSDEW7j09LQrzVJrZv3y/t4rYhPhNW+sEck3HNpsx3vN9DPU56c/N095lNynq1dE=";
