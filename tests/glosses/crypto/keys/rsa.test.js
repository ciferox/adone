...
describe("crypto", "keys", "RSA", function () {
...
`;
        ...
        it("can read a private encrypted key (v2 aes-128-cbc)", () => {
            /**
             * Generated with
             * openssl genpkey -algorithm RSA
             *   -pkeyopt rsa_keygen_bits:1024
...
`;
        ...
        it("can read a private encrypted key (v2 aes-256-cbc)", () => {
            /**
             * Generated with
             * openssl genpkey -algorithm RSA
             *   -pkeyopt rsa_keygen_bits:1024
...
`;
        ...
        it("can read a private encrypted key (v2 des)", () => {
            /**
             * Generated with
             * openssl genpkey -algorithm RSA
             *   -pkeyopt rsa_keygen_bits:1024
