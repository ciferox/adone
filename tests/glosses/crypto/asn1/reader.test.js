...
const BerReader = adone.crypto.asn1.BerReader;


describe("ASN.1", function () {
    describe("BerReader", function () {
        ...
        it("read 1 byte negative int", function() {
        ...
        it("read 2 byte negative int", function() {
        ...
        it("read 3 byte negative int", function() {
        ...
        it("read 4 byte negative int", function() {
        ...
        it("read boolean false", function() {
        ...
        it("anonymous LDAPv3 bind", function() {
