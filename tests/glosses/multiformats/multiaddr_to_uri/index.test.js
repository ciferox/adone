const {
    multiformat: { multiaddrToUri }
} = adone;

describe("multiformat", "multiaddrToUri", () => {
    ...
    it("should convert multiaddr to URI", () => {
        const data = [
            ...
            ["/ip6/::/tcp/0/wss", "wss://[::]:0"],
            [
                "/ip4/1.2.3.4/tcp/3456/ws/p2p-webrtc-star/p2p/QmcgpsyWgH8Y8ajJz1Cu72KnS5uo2Aa2LpzU7kinSoooo",
                "ws://1.2.3.4:3456/p2p-webrtc-star/p2p/QmcgpsyWgH8Y8ajJz1Cu72KnS5uo2Aa2LpzU7kinSoooo"
            ],
            [
                "/dnsaddr/ipfs.io/ws/p2p-webrtc-star/p2p/QmcgpsyWgH8Y8ajJz1Cu72KnS5uo2Aa2LpzU7kinSoooo4",
                "ws://ipfs.io/p2p-webrtc-star/p2p/QmcgpsyWgH8Y8ajJz1Cu72KnS5uo2Aa2LpzU7kinSoooo4"
            ],
            [
                "/dnsaddr/ipfs.io/wss/p2p-webrtc-star/p2p/QmcgpsyWgH8Y8ajJz1Cu72KnS5uo2Aa2LpzU7kinSoooo4",
                "wss://ipfs.io/p2p-webrtc-star/p2p/QmcgpsyWgH8Y8ajJz1Cu72KnS5uo2Aa2LpzU7kinSoooo4"
            ],
            [
                "/ip6/::/tcp/0/ws/p2p-webrtc-star/p2p/QmcgpsyWgH8Y8ajJz1Cu72KnS5uo2Aa2LpzU7kinSoooo5",
                "ws://[::]:0/p2p-webrtc-star/p2p/QmcgpsyWgH8Y8ajJz1Cu72KnS5uo2Aa2LpzU7kinSoooo5"
            ],
            [
                "/dns4/wrtc-star.discovery.libp2p.io/tcp/443/wss/p2p-webrtc-star/p2p/QmTysQQiTGMdfRsDQp516oZ9bR3FiSCDnicUnqny2q1d79",
            ...
            [
                ...
                "ws://localhost/p2p-websocket-star/p2p/QmcgpsyWgH8Y8ajJz1Cu72KnS5uo2Aa2LpzU7kinSoooo4"
            ],
            [
                "/ip4/1.2.3.4/tcp/3456/ws/p2p-websocket-star/p2p/QmcgpsyWgH8Y8ajJz1Cu72KnS5uo2Aa2LpzU7kinSoooo4",
                "ws://1.2.3.4:3456/p2p-websocket-star/p2p/QmcgpsyWgH8Y8ajJz1Cu72KnS5uo2Aa2LpzU7kinSoooo4"
            ],
            [
                "/dns4/ws-star.discovery.libp2p.io/tcp/443/wss/p2p-websocket-star/p2p/Qma3uqwymdqwXtC4uvmqqwwMhTDHD7xp9FzM75tQB5qRM3",
                "wss://ws-star.discovery.libp2p.io:443/p2p-websocket-star/p2p/Qma3uqwymdqwXtC4uvmqqwwMhTDHD7xp9FzM75tQB5qRM3"
            ],
            [
            ...
            [
                ...
                "ws://1.2.3.4:3456/p2p-webrtc-star/p2p/QmcgpsyWgH8Y8ajJz1Cu72KnS5uo2Aa2LpzU7kinSoooo4"
            ],
            [
                "/ip4/1.2.3.4/tcp/3456/p2p/QmcgpsyWgH8Y8ajJz1Cu72KnS5uo2Aa2LpzU7kinSoooo4",
                "tcp://1.2.3.4:3456/p2p/QmcgpsyWgH8Y8ajJz1Cu72KnS5uo2Aa2LpzU7kinSoooo4"
            ]
        ];

        data.forEach((d) => assert.equal(multiaddrToUri(d[0]), d[1]));
    });
    ...
    it("should convert multiaddr to tcp:// URI when explicit { assumeHttp: false }", () => {
        ...
        data.forEach((d) => assert.equal(multiaddrToUri(d[0], { assumeHttp: false }), d[1]));
    });

    it("should throw for unsupported protocol", () => {
        assert.throws(() => multiaddrToUri("/quic"));
    });
});
