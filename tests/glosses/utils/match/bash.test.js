...
describe("util", "match", "bash options and features:", () => {
    describe("failglob:", () => {
        it("should throw an error when no matches are found:", () => {
            assert.throws(() => {
                mm.match(fixtures, "\\^", { failglob: true });
    ...
    describe("bash", () => {
        ...
        it("should work for escaped characters", () => {
            match(fixtures, "\\**", ["*", "**"]);
        });
        ...
        it("should not expand literal braces inside brackets", () => {
