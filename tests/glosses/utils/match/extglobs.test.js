...
describe("util", "match", "extglobs", () => {
    ...
    it("should match extglobs with wildcards (issue #100)", () => {
    ...
    it("should support negation", () => {
        const arr = ["a", "b", "aa", "ab", "bb", "ac", "aaa", "aab", "abb", "ccc"];
        mm(arr, "!(a)*", ["b", "bb", "ccc"]);
    ...
    it("should work with globs", () => {
        const arr = ["123abc", "ab", "abab", "abcdef", "accdef", "abcfefg", "abef", "abcfef", "abd", "acd"];
    ...
    it("this doesn't work in bash either (per bash micromatch.tests notes)", () => {
        assert(!mm.isMatch("*(a|b[)", "*(a|b\\[)"));
        assert(mm.isMatch("*(a|b[)", "\\*\\(a\\|b\\[\\)"));
    });

    it("should support multiple exclusion patterns in one extglob:", () => {
...
describe("util", "match", "bash", () => {
    ...
    it("should support basic wildmatch features", () => {
    ...
    it("Test recursion and the abort code", () => {
