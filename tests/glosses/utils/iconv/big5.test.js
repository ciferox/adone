describe("glosses", "utils", "iconv", "big5", () => {
    ...
    const testStringBig5Buffer = new Buffer([0xa4, 0xa4, 0xa4, 0xe5, 0x61, 0x62, 0x63]);
    const testString2 = "測試";
    const testStringBig5Buffer2 = new Buffer([0xb4, 0xfa, 0xb8, 0xd5]);
    ...
    it("Big5 correctly decodes and encodes characters · and ×", () => {
        ...
        const chars = "·×";
        const big5Chars = new Buffer([0xA1, 0x50, 0xA1, 0xD1]);
