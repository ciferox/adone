describe("glosses", "utils", "iconv", "ShiftJIS tests", () => {
    ...
    it("ShiftJIS correctly encoded/decoded", () => {
        ...
        const testStringBig5Buffer = new Buffer([0x92, 0x86, 0x95, 0xb6, 0x61, 0x62, 0x63]);
        const testString2 = "測試";
        const testStringBig5Buffer2 = new Buffer([0x91, 0xaa, 0x8e, 0x8e]);
    ...
    it("ShiftJIS extended chars are decoded, but not encoded", () => {
        let buf = new Buffer("ed40eefceeef", "hex"), str = "纊＂ⅰ", res = "fa5cfa57fa40", // repeated block (these same chars are repeated in the different place)
