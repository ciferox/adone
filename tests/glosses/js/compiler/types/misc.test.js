...
describe("js", "compiler", "types", "misc helpers", () => {
    describe("matchesPattern", () => {
        it("matches explicitly", () => {
            ...
            assert.false(t.matchesPattern(ast, "a.b.c"));
            assert.false(t.matchesPattern(ast, "b.c.d"));
            assert.false(t.matchesPattern(ast, "a.b.c.d.e"));
        });
        ...
        it("matches partially", () => {
            ...
            assert.false(t.matchesPattern(ast, "b.c.d", true));
            assert.false(t.matchesPattern(ast, "a.b.c.d.e", true));
        });
