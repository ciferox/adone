...
describe("source maps", () => {
    it.todo("should generate correct mappings", async () => {
        const code = [
            "function foo(bar) {",
            "  return 1 + bar;",
            "}"
    ...
    it("should compose with inputSourceMap", async () => {
    ...
    it("should work when a child node becomes null", () => {
    ...
    it("should tolerate programs that become empty", () => {
        const source = "foo();";
