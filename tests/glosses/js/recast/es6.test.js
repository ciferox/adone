...
describe("ES6 Compatability", () => {
    function convertShorthandMethod() {
        ...
        const newES5MethodProperty = b.property(methodDecProperty.kind, methodDecProperty.key, methodDecProperty.value);
        const correctMethodProperty = b.property(methodDecProperty.kind, methodDecProperty.key, b.functionExpression(methodDecProperty.value.id, methodDecProperty.value.params, methodDecProperty.value.body, methodDecProperty.value.generator, methodDecProperty.value.expression));
        assert.strictEqual(printer.print(newES5MethodProperty).code, printer.print(correctMethodProperty).code);
    }
...
describe("import/export syntax", () => {
    ...
    it("should parse and print import statements correctly", () => {
    ...
    it("should parse and print export statements correctly", () => {
        // default exports
    ...
    it.todo("should forbid invalid import/export syntax", () => {
    ...
    it("should pretty-print template strings with backticks", () => {
        const code = [
            'var noun = "fool";',
            "var s = `I am a ${noun}`;",
