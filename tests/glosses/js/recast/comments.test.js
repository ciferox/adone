...
function runTestsForParser(parserId) {
    ...
    pit("attachment and reprinting", () => {
        ...
        assert.strictEqual(recast.print(dup.body).code, ["/* string */"].concat(annotated.slice(2)).join(eol));
    ...
    pit("TrailingComments", () => {
        ...
        recast.types.astNodesAreEquivalent.assert(ast, recast.parse(actual, { parser }));
    ...
    pit("should correctly attach to concise methods", () => {
    ...
    pit("should attach comments as configurable", () => {
        // Given
    ...
    pit("should be reprinted when modified", () => {
        const code = [
            "foo;",
            "// bar",
            "bar;"
    ...
    pit("should preserve stray non-comment syntax", () => {
        const code = [
            "[",
            "  foo",
            "  , /* comma */",
    ...
    pit("should be reprinted even if dangling", () => {
    ...
    pit("should attach to program.body[0] instead of program", () => {
        const code = [
            "// comment 1",
            "var a;",
            "// comment 2",
    ...
    pit("should not collapse multi line function definitions", () => {
        const code = [
            "var obj = {",
            "  a(",
            "    /*before*/ param",
    ...
    pit("should be pretty-printable in illegal positions", () => {
        const code = [
    ...
    pit("should preserve correctness when a return expression has a comment", () => {
        const code = [
            "function f() {",
            "  return 3;",
            "}"
    ...
    pit("should wrap in parens when the return expression has nested leftmost comment", () => {
        const code = [
            "function f() {",
            "  return 1 + 2;",
            "}"
    ...
    pit("should not wrap in parens when the return expression has an interior comment", () => {
        const code = [
            "function f() {",
            "  return 1 + 2;",
            "}"
    ...
    pit("should not reformat a return statement that is not modified", () => {
        const code = [
            "function f() {",
            "  return      {",
            "    a:     1,",
    ...
    pit("should correctly handle a removing the argument from a return", () => {
        const code = [
            "function f() {",
            "  return 'foo';",
            "}"
    ...
    pit("should preserve comments attached to EmptyStatement", () => {
        const code = [
            "removeThisStatement;",
            "// comment",
            ";(function() {})();"
