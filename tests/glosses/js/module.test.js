describe("js", "Module", () => {
    ...
    describe("refs", () => {
        ...
        describe("unref", () => {
            const createModule = () => new js.Module(root.getFile("random_name").path());
            it("should delete from cache if only 1 ref", async () => {
                memory.add((ctx) => ({
                    "test.js": ctx.file(`
                        module.exports = 123;
                    `)
    ...
    describe("builtin modules", () => {
        for (const moduleName of [
            ...
            it(`should load ${moduleName}`, () => {
                const m = new js.Module("doesnt matter");
