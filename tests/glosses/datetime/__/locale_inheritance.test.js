describe("datetime", "locale inheritance", () => {
    ...
    it("calendar", () => {
        adone.datetime.defineLocale("base-cal", {
            calendar: {
        ...
        adone.datetime.defineLocale("child-cal", {
        ...
        adone.datetime.locale("child-cal");
    ...
    it("missing", () => {
        adone.datetime.defineLocale("base-cal-2", {
            calendar: {
                sameDay: "[Today at] HH:mm",
                nextDay: "[Tomorrow at] HH:mm",
                nextWeek: "[Next week at] HH:mm",
        ...
        adone.datetime.defineLocale("child-cal-2", {
            parentLocale: "base-cal-2"
        });
        adone.datetime.locale("child-cal-2");
        const anchor = adone.datetime.utc("2015-05-05T12:00:00", adone.datetime.ISO_8601);
    ...
    it("long date format", () => {
        adone.datetime.defineLocale("base-ldf", {
            longDateFormat: {
                LTS: "h:mm:ss A",
                LT: "h:mm A",
                L: "MM/DD/YYYY",
        ...
        adone.datetime.defineLocale("child-ldf", {
        ...
        adone.datetime.locale("child-ldf");
    ...
    it("ordinal", () => {
        adone.datetime.defineLocale("base-ordinal-1", {
            ordinal: "%dx"
        });
        adone.datetime.defineLocale("child-ordinal-1", {
        ...
        adone.datetime.defineLocale("base-ordinal-2", {
            ordinal: "%dx"
        });
        adone.datetime.defineLocale("child-ordinal-2", {
        ...
        adone.datetime.defineLocale("base-ordinal-3", {
            ordinal(num) {
                return `${num}x`;
            }
        });
        adone.datetime.defineLocale("child-ordinal-3", {
    ...
    it("ordinal parse", () => {
        adone.datetime.defineLocale("base-ordinal-parse-1", {
            dayOfMonthOrdinalParse: /\d{1,2}x/
        });
        adone.datetime.defineLocale("child-ordinal-parse-1", {
        ...
        adone.datetime.defineLocale("base-ordinal-parse-2", {
            dayOfMonthOrdinalParse: /\d{1,2}x/
        });
        adone.datetime.defineLocale("child-ordinal-parse-2", {
    ...
    it("months", () => {
        adone.datetime.defineLocale("base-months", {
            months: "One_Two_Three_Four_Five_Six_Seven_Eight_Nine_Ten_Eleven_Twelve".split("_")
        });
        adone.datetime.defineLocale("child-months", {
    ...
    it("define child locale before parent", () => {
        adone.datetime.defineLocale("months-x", null);
        adone.datetime.defineLocale("base-months-x", null);

        adone.datetime.defineLocale("months-x", {
            parentLocale: "base-months-x",
            months: "First_Second_Third_Fourth_Fifth_Sixth_Seventh_Eighth_Ninth_Tenth_Eleventh_Twelveth ".split("_")
        });
        assert.equal(adone.datetime.locale(), "en", "failed to set a locale requiring missing parent");
        adone.datetime.defineLocale("base-months-x", {
            months: "One_Two_Three_Four_Five_Six_Seven_Eight_Nine_Ten_Eleven_Twelve".split("_")
        });
        assert.equal(adone.datetime.locale(), "base-months-x", "defineLocale should also set the locale (regardless of child locales)");

        assert.equal(adone.datetime().locale("months-x").month(0).format("MMMM"), "First", "loading child before parent locale works");
    });
});
