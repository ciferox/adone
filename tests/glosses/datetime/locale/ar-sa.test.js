...
describe("ar-sa", () => {
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "اليوم على الساعة ١٢:٠٠", "today at the same time");
    ...
    it("weeks year starting wednesday custom", () => {
        assert.equal(adone.datetime("2003 1 6", "gggg w d").format("YYYY-MM-DD"), "٢٠٠٣-٠١-٠٤", "2003 1 6 : gggg w d");
        assert.equal(adone.datetime("2003 1 0", "gggg w e").format("YYYY-MM-DD"), "٢٠٠٢-١٢-٢٩", "2003 1 0 : gggg w e");
        assert.equal(adone.datetime("2003 1 6", "gggg w d").format("gggg w d"), "٢٠٠٣ ١ ٦", "2003 1 6 : gggg w d");
        assert.equal(adone.datetime("2003 1 0", "gggg w e").format("gggg w e"), "٢٠٠٣ ١ ٠", "2003 1 0 : gggg w e");
    });

    it("weeks year starting sunday formatted", () => {
        assert.equal(adone.datetime([2011, 11, 31]).format("w ww wo"), "٥٣ ٥٣ ٥٣", "2011 11 31");
        assert.equal(adone.datetime([2012, 0, 6]).format("w ww wo"), "١ ٠١ ١", "2012 0 6");
        assert.equal(adone.datetime([2012, 0, 7]).format("w ww wo"), "١ ٠١ ١", "2012 0 7");
        assert.equal(adone.datetime([2012, 0, 13]).format("w ww wo"), "٢ ٠٢ ٢", "2012 0 13");
        assert.equal(adone.datetime([2012, 0, 14]).format("w ww wo"), "٢ ٠٢ ٢", "2012 0 14");
    });
});
