...
describe("ss", () => {
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "nga emizuzwana lomcane", "prefix");
        assert.equal(adone.datetime(0).from(30000), "wenteka nga emizuzwana lomcane", "suffix");
    });

    it("now from now", () => {
        assert.equal(adone.datetime().fromNow(), "wenteka nga emizuzwana lomcane", "now from now should display as in the past");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "Namuhla nga 12:00 emini", "Today at the same time");
    ...
    it("weeks year starting sunday formatted", () => {
        ...
        assert.equal(adone.datetime([2012, 0, 2]).format("w ww wo"), "1 01 1", "Jan  4 2012 should be week 1");
