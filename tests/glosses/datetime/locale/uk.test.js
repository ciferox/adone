...
describe("uk", () => {
    ...
    it("format meridiem", () => {
        assert.equal(adone.datetime([2012, 11, 28, 0, 0]).format("A"), "ночі", "night");
        assert.equal(adone.datetime([2012, 11, 28, 3, 59]).format("A"), "ночі", "night");
        assert.equal(adone.datetime([2012, 11, 28, 4, 0]).format("A"), "ранку", "morning");
        assert.equal(adone.datetime([2012, 11, 28, 11, 59]).format("A"), "ранку", "morning");
        ...
        assert.equal(adone.datetime([2012, 11, 28, 17, 0]).format("A"), "вечора", "evening");
        assert.equal(adone.datetime([2012, 11, 28, 23, 59]).format("A"), "вечора", "evening");
    });
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "за декілька секунд", "prefix");
        assert.equal(adone.datetime(0).from(30000), "декілька секунд тому", "suffix");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "Сьогодні о 12:00", "today at the same time");
    ...
    it("weeks year starting sunday formatted", () => {
        assert.equal(adone.datetime([2011, 11, 26]).format("w ww wo"), "1 01 1-й", "Dec 26 2011 should be week 1");
        assert.equal(adone.datetime([2012, 0, 1]).format("w ww wo"), "1 01 1-й", "Jan  1 2012 should be week 1");
        assert.equal(adone.datetime([2012, 0, 2]).format("w ww wo"), "2 02 2-й", "Jan  2 2012 should be week 2");
        assert.equal(adone.datetime([2012, 0, 8]).format("w ww wo"), "2 02 2-й", "Jan  8 2012 should be week 2");
        assert.equal(adone.datetime([2012, 0, 9]).format("w ww wo"), "3 03 3-й", "Jan  9 2012 should be week 3");
    });
});
