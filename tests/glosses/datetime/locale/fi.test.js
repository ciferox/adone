...
describe("datetime", "locale", "fi", () => {
    ...
    it("format ordinal", () => {
        assert.equal(adone.datetime([2011, 0, 1]).format("DDDo"), "1.", "1st");
        assert.equal(adone.datetime([2011, 0, 2]).format("DDDo"), "2.", "2nd");
        assert.equal(adone.datetime([2011, 0, 3]).format("DDDo"), "3.", "3rd");
        assert.equal(adone.datetime([2011, 0, 4]).format("DDDo"), "4.", "4th");
        assert.equal(adone.datetime([2011, 0, 5]).format("DDDo"), "5.", "5th");
        assert.equal(adone.datetime([2011, 0, 6]).format("DDDo"), "6.", "6th");
        assert.equal(adone.datetime([2011, 0, 7]).format("DDDo"), "7.", "7th");
        assert.equal(adone.datetime([2011, 0, 8]).format("DDDo"), "8.", "8th");
        assert.equal(adone.datetime([2011, 0, 9]).format("DDDo"), "9.", "9th");
        assert.equal(adone.datetime([2011, 0, 10]).format("DDDo"), "10.", "10th");

        assert.equal(adone.datetime([2011, 0, 11]).format("DDDo"), "11.", "11th");
        assert.equal(adone.datetime([2011, 0, 12]).format("DDDo"), "12.", "12th");
        assert.equal(adone.datetime([2011, 0, 13]).format("DDDo"), "13.", "13th");
        assert.equal(adone.datetime([2011, 0, 14]).format("DDDo"), "14.", "14th");
        assert.equal(adone.datetime([2011, 0, 15]).format("DDDo"), "15.", "15th");
        assert.equal(adone.datetime([2011, 0, 16]).format("DDDo"), "16.", "16th");
        assert.equal(adone.datetime([2011, 0, 17]).format("DDDo"), "17.", "17th");
        assert.equal(adone.datetime([2011, 0, 18]).format("DDDo"), "18.", "18th");
        assert.equal(adone.datetime([2011, 0, 19]).format("DDDo"), "19.", "19th");
        assert.equal(adone.datetime([2011, 0, 20]).format("DDDo"), "20.", "20th");

        assert.equal(adone.datetime([2011, 0, 21]).format("DDDo"), "21.", "21st");
        assert.equal(adone.datetime([2011, 0, 22]).format("DDDo"), "22.", "22nd");
        assert.equal(adone.datetime([2011, 0, 23]).format("DDDo"), "23.", "23rd");
        assert.equal(adone.datetime([2011, 0, 24]).format("DDDo"), "24.", "24th");
        assert.equal(adone.datetime([2011, 0, 25]).format("DDDo"), "25.", "25th");
        assert.equal(adone.datetime([2011, 0, 26]).format("DDDo"), "26.", "26th");
        assert.equal(adone.datetime([2011, 0, 27]).format("DDDo"), "27.", "27th");
        assert.equal(adone.datetime([2011, 0, 28]).format("DDDo"), "28.", "28th");
        assert.equal(adone.datetime([2011, 0, 29]).format("DDDo"), "29.", "29th");
        assert.equal(adone.datetime([2011, 0, 30]).format("DDDo"), "30.", "30th");

        assert.equal(adone.datetime([2011, 0, 31]).format("DDDo"), "31.", "31st");
    });
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "muutaman sekunnin päästä", "prefix");
        assert.equal(adone.datetime(0).from(30000), "muutama sekunti sitten", "suffix");
    });

    it("now from now", () => {
        assert.equal(adone.datetime().fromNow(), "muutama sekunti sitten", "now from now should display as in the past");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "tänään klo 12.00", "today at the same time");
