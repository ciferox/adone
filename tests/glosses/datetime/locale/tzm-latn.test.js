...
describe("datetime", "locale", "tzm-latn", () => {
    ...
    beforeEach(() => {
        adone.datetime.locale("tzm-latn");
    });
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "dadkh s yan imik", "prefix");
        assert.equal(adone.datetime(0).from(30000), "yan imik", "suffix");
    });

    it("now from now", () => {
        assert.equal(adone.datetime().fromNow(), "yan imik", "now from now should display as in the past");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "asdkh g 12:00", "today at the same time");
