...
describe("sk", () => {
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "za pár sekúnd", "prefix");
        assert.equal(adone.datetime(0).from(30000), "pred pár sekundami", "suffix");
    });

    it("now from now", () => {
        assert.equal(adone.datetime().fromNow(), "pred pár sekundami", "now from now should display as in the past");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "dnes o 12:00", "today at the same time");
    ...
    it("humanize duration", () => {
        assert.equal(adone.datetime.duration(1, "minutes").humanize(), "minúta", "a minute (future)");
        assert.equal(adone.datetime.duration(1, "minutes").humanize(true), "za minútu", "in a minute");
        assert.equal(adone.datetime.duration(-1, "minutes").humanize(), "minúta", "a minute (past)");
        assert.equal(adone.datetime.duration(-1, "minutes").humanize(true), "pred minútou", "a minute ago");
    });
