...
describe("be", () => {
    ...
    it("format meridiem", () => {
        assert.equal(adone.datetime([2012, 11, 28, 0, 0]).format("A"), "ночы", "night");
        assert.equal(adone.datetime([2012, 11, 28, 3, 59]).format("A"), "ночы", "night");
        assert.equal(adone.datetime([2012, 11, 28, 4, 0]).format("A"), "раніцы", "morning");
        assert.equal(adone.datetime([2012, 11, 28, 11, 59]).format("A"), "раніцы", "morning");
        ...
        assert.equal(adone.datetime([2012, 11, 28, 17, 0]).format("A"), "вечара", "evening");
        assert.equal(adone.datetime([2012, 11, 28, 23, 59]).format("A"), "вечара", "evening");
    });

    it("format ordinal", () => {
        assert.equal(adone.datetime([2011, 0, 1]).format("DDDo"), "1-ы", "1-ы");
        assert.equal(adone.datetime([2011, 0, 2]).format("DDDo"), "2-і", "2-і");
        assert.equal(adone.datetime([2011, 0, 3]).format("DDDo"), "3-і", "3-і");
        assert.equal(adone.datetime([2011, 0, 4]).format("DDDo"), "4-ы", "4-ы");
        assert.equal(adone.datetime([2011, 0, 5]).format("DDDo"), "5-ы", "5-ы");
        assert.equal(adone.datetime([2011, 0, 6]).format("DDDo"), "6-ы", "6-ы");
        assert.equal(adone.datetime([2011, 0, 7]).format("DDDo"), "7-ы", "7-ы");
        assert.equal(adone.datetime([2011, 0, 8]).format("DDDo"), "8-ы", "8-ы");
        assert.equal(adone.datetime([2011, 0, 9]).format("DDDo"), "9-ы", "9-ы");
        assert.equal(adone.datetime([2011, 0, 10]).format("DDDo"), "10-ы", "10-ы");

        assert.equal(adone.datetime([2011, 0, 11]).format("DDDo"), "11-ы", "11-ы");
        assert.equal(adone.datetime([2011, 0, 12]).format("DDDo"), "12-ы", "12-ы");
        assert.equal(adone.datetime([2011, 0, 13]).format("DDDo"), "13-ы", "13-ы");
        assert.equal(adone.datetime([2011, 0, 14]).format("DDDo"), "14-ы", "14-ы");
        assert.equal(adone.datetime([2011, 0, 15]).format("DDDo"), "15-ы", "15-ы");
        assert.equal(adone.datetime([2011, 0, 16]).format("DDDo"), "16-ы", "16-ы");
        assert.equal(adone.datetime([2011, 0, 17]).format("DDDo"), "17-ы", "17-ы");
        assert.equal(adone.datetime([2011, 0, 18]).format("DDDo"), "18-ы", "18-ы");
        assert.equal(adone.datetime([2011, 0, 19]).format("DDDo"), "19-ы", "19-ы");
        assert.equal(adone.datetime([2011, 0, 20]).format("DDDo"), "20-ы", "20-ы");

        assert.equal(adone.datetime([2011, 0, 21]).format("DDDo"), "21-ы", "21-ы");
        assert.equal(adone.datetime([2011, 0, 22]).format("DDDo"), "22-і", "22-і");
        assert.equal(adone.datetime([2011, 0, 23]).format("DDDo"), "23-і", "23-і");
        assert.equal(adone.datetime([2011, 0, 24]).format("DDDo"), "24-ы", "24-ы");
        assert.equal(adone.datetime([2011, 0, 25]).format("DDDo"), "25-ы", "25-ы");
        assert.equal(adone.datetime([2011, 0, 26]).format("DDDo"), "26-ы", "26-ы");
        assert.equal(adone.datetime([2011, 0, 27]).format("DDDo"), "27-ы", "27-ы");
        assert.equal(adone.datetime([2011, 0, 28]).format("DDDo"), "28-ы", "28-ы");
        assert.equal(adone.datetime([2011, 0, 29]).format("DDDo"), "29-ы", "29-ы");
        assert.equal(adone.datetime([2011, 0, 30]).format("DDDo"), "30-ы", "30-ы");

        assert.equal(adone.datetime([2011, 0, 31]).format("DDDo"), "31-ы", "31-ы");
    });
    ...
    it("format month case with escaped symbols", () => {
        ...
        for (i = 0; i < 12; i++) {
            ...
            assert.equal(adone.datetime([2013, i, 1]).format("D[-ы дзень] MMMM"), "1-ы дзень " + months.accusative[i], "1-ы дзень " + months.accusative[i]);
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "праз некалькі секунд", "prefix");
        assert.equal(adone.datetime(0).from(30000), "некалькі секунд таму", "suffix");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "Сёння ў 12:00", "today at the same time");
    ...
    it("weeks year starting sunday formatted", () => {
        assert.equal(adone.datetime([2011, 11, 26]).format("w ww wo"), "1 01 1-ы", "Dec 26 2011 should be week 1");
        assert.equal(adone.datetime([2012, 0, 1]).format("w ww wo"), "1 01 1-ы", "Jan  1 2012 should be week 1");
        assert.equal(adone.datetime([2012, 0, 2]).format("w ww wo"), "2 02 2-і", "Jan  2 2012 should be week 2");
        assert.equal(adone.datetime([2012, 0, 8]).format("w ww wo"), "2 02 2-і", "Jan  8 2012 should be week 2");
        assert.equal(adone.datetime([2012, 0, 9]).format("w ww wo"), "3 03 3-і", "Jan  9 2012 should be week 3");
    });
});
