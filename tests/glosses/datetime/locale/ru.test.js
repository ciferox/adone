...
describe("datetime", "locale", "ru", () => {
    ...
    it("weeks year starting sunday formatted", () => {
        assert.equal(adone.datetime([2011, 11, 26]).format("w ww wo"), "1 01 1-я", "Dec 26 2011 should be week 1");
        assert.equal(adone.datetime([2012, 0, 1]).format("w ww wo"), "1 01 1-я", "Jan  1 2012 should be week 1");
        assert.equal(adone.datetime([2012, 0, 2]).format("w ww wo"), "2 02 2-я", "Jan  2 2012 should be week 2");
        assert.equal(adone.datetime([2012, 0, 8]).format("w ww wo"), "2 02 2-я", "Jan  8 2012 should be week 2");
        assert.equal(adone.datetime([2012, 0, 9]).format("w ww wo"), "3 03 3-я", "Jan  9 2012 should be week 3");
    });
});
