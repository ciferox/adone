...
describe("fo", () => {
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "um fá sekund", "prefix");
        assert.equal(adone.datetime(0).from(30000), "fá sekund síðani", "suffix");
    });

    it("now from now", () => {
        assert.equal(adone.datetime().fromNow(), "fá sekund síðani", "now from now should display as in the past");
    });
