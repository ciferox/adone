...
describe("datetime", "locale", "br", () => {
    ...
    it("format ordinal", () => {
        adone.datetime.locale("br");
        assert.equal(adone.datetime([2011, 0, 1]).format("DDDo"), "1añ", "1añ");
        assert.equal(adone.datetime([2011, 0, 2]).format("DDDo"), "2vet", "2vet");
        assert.equal(adone.datetime([2011, 0, 3]).format("DDDo"), "3vet", "3vet");
        assert.equal(adone.datetime([2011, 0, 4]).format("DDDo"), "4vet", "4vet");
        assert.equal(adone.datetime([2011, 0, 5]).format("DDDo"), "5vet", "5vet");
        assert.equal(adone.datetime([2011, 0, 6]).format("DDDo"), "6vet", "6vet");
        assert.equal(adone.datetime([2011, 0, 7]).format("DDDo"), "7vet", "7vet");
        assert.equal(adone.datetime([2011, 0, 8]).format("DDDo"), "8vet", "8vet");
        assert.equal(adone.datetime([2011, 0, 9]).format("DDDo"), "9vet", "9vet");
        assert.equal(adone.datetime([2011, 0, 10]).format("DDDo"), "10vet", "10vet");

        assert.equal(adone.datetime([2011, 0, 11]).format("DDDo"), "11vet", "11vet");
        assert.equal(adone.datetime([2011, 0, 12]).format("DDDo"), "12vet", "12vet");
        assert.equal(adone.datetime([2011, 0, 13]).format("DDDo"), "13vet", "13vet");
        assert.equal(adone.datetime([2011, 0, 14]).format("DDDo"), "14vet", "14vet");
        assert.equal(adone.datetime([2011, 0, 15]).format("DDDo"), "15vet", "15vet");
        assert.equal(adone.datetime([2011, 0, 16]).format("DDDo"), "16vet", "16vet");
        assert.equal(adone.datetime([2011, 0, 17]).format("DDDo"), "17vet", "17vet");
        assert.equal(adone.datetime([2011, 0, 18]).format("DDDo"), "18vet", "18vet");
        assert.equal(adone.datetime([2011, 0, 19]).format("DDDo"), "19vet", "19vet");
        assert.equal(adone.datetime([2011, 0, 20]).format("DDDo"), "20vet", "20vet");

        assert.equal(adone.datetime([2011, 0, 21]).format("DDDo"), "21vet", "21vet");
        assert.equal(adone.datetime([2011, 0, 22]).format("DDDo"), "22vet", "22vet");
        assert.equal(adone.datetime([2011, 0, 23]).format("DDDo"), "23vet", "23vet");
        assert.equal(adone.datetime([2011, 0, 24]).format("DDDo"), "24vet", "24vet");
        assert.equal(adone.datetime([2011, 0, 25]).format("DDDo"), "25vet", "25vet");
        assert.equal(adone.datetime([2011, 0, 26]).format("DDDo"), "26vet", "26vet");
        assert.equal(adone.datetime([2011, 0, 27]).format("DDDo"), "27vet", "27vet");
        assert.equal(adone.datetime([2011, 0, 28]).format("DDDo"), "28vet", "28vet");
        assert.equal(adone.datetime([2011, 0, 29]).format("DDDo"), "29vet", "29vet");
        assert.equal(adone.datetime([2011, 0, 30]).format("DDDo"), "30vet", "30vet");

        assert.equal(adone.datetime([2011, 0, 31]).format("DDDo"), "31vet", "31vet");
    });
    ...
    it("suffix", () => {
        adone.datetime.locale("br");
        assert.equal(adone.datetime(30000).from(0), "a-benn un nebeud segondennoù", "prefix");
        assert.equal(adone.datetime(0).from(30000), "un nebeud segondennoù 'zo", "suffix");
    });

    it("now from now", () => {
        adone.datetime.locale("br");
        assert.equal(adone.datetime().fromNow(), "un nebeud segondennoù 'zo", "now from now should display as in the past");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "Hiziv da 12e00 PM", "today at the same time");
