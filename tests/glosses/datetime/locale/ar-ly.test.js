...
describe("ar-ly", () => {
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "بعد 30 ثانية", "prefix");
        assert.equal(adone.datetime(0).from(30000), "منذ 30 ثانية", "suffix");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "اليوم عند الساعة 12:00", "today at the same time");
    ...
    it("weeks year starting wednesday custom", () => {
        assert.equal(adone.datetime("2003 1 6", "gggg w d").format("YYYY-MM-DD"), "2002-12-28", "Week 1 of 2003 should be Dec 28 2002");
        assert.equal(adone.datetime("2003 1 0", "gggg w e").format("YYYY-MM-DD"), "2002-12-28", "Week 1 of 2003 should be Dec 28 2002");
        assert.equal(adone.datetime("2003 1 6", "gggg w d").format("gggg w d"), "2003 1 6", "Saturday of week 1 of 2003 parsed should be formatted as 2003 1 6");
        assert.equal(adone.datetime("2003 1 0", "gggg w e").format("gggg w e"), "2003 1 0", "1st day of week 1 of 2003 parsed should be formatted as 2003 1 0");
    });
    ...
    it("weeks year starting sunday formatted", () => {
        ...
        assert.equal(adone.datetime([2012, 0, 6]).format("w ww wo"), "1 01 1", "Jan  6 2012 should be week 1");
        assert.equal(adone.datetime([2012, 0, 7]).format("w ww wo"), "2 02 2", "Jan  7 2012 should be week 2");
        assert.equal(adone.datetime([2012, 0, 13]).format("w ww wo"), "2 02 2", "Jan 13 2012 should be week 2");
