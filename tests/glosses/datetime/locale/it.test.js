...
describe("datetime", "locale", "it", () => {
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "in alcuni secondi", "prefix");
        assert.equal(adone.datetime(0).from(30000), "alcuni secondi fa", "suffix");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "Oggi alle 12:00", "today at the same time");
