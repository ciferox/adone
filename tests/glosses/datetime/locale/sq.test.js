...
describe("datetime", "locale", "sq", () => {
    ...
    it("meridiem", () => {
        assert.equal(adone.datetime([2011, 2, 23, 0, 0]).format("A"), "PD", "before dawn");
        assert.equal(adone.datetime([2011, 2, 23, 12, 0]).format("A"), "MD", "noon");
    });
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "në disa sekonda", "prefix");
        assert.equal(adone.datetime(0).from(30000), "disa sekonda më parë", "suffix");
    });

    it("now from now", () => {
        assert.equal(adone.datetime().fromNow(), "disa sekonda më parë", "now from now should display as in the past");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "Sot në 12:00", "today at the same time");
