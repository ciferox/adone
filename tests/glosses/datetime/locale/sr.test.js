...
describe("sr", () => {
    ...
    it("suffix", () => {
        ...
        assert.equal(adone.datetime(0).from(30000), "pre nekoliko sekundi", "prefix");
    });

    it("now from now", () => {
        assert.equal(adone.datetime().fromNow(), "pre nekoliko sekundi", "now from now should display as in the past");
    });
