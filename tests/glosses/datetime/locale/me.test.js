...
describe("me", () => {
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "za nekoliko sekundi", "prefix");
        assert.equal(adone.datetime(0).from(30000), "prije nekoliko sekundi", "prefix");
    });

    it("now from now", () => {
        assert.equal(adone.datetime().fromNow(), "prije nekoliko sekundi", "now from now should display as in the past");
    });
