...
describe("datetime", "locale", "tl-ph", () => {
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "sa loob ng ilang segundo", "prefix");
        assert.equal(adone.datetime(0).from(30000), "ilang segundo ang nakalipas", "suffix");
    });
    ...
    it("same day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "12:00 ngayong araw", "today at the same time");
