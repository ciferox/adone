...
describe("tzm", () => {
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "ⴷⴰⴷⵅ ⵙ ⵢⴰⵏ ⵉⵎⵉⴽ", "prefix");
        assert.equal(adone.datetime(0).from(30000), "ⵢⴰⵏ ⵉⵎⵉⴽ", "suffix");
    });

    it("now from now", () => {
        assert.equal(adone.datetime().fromNow(), "ⵢⴰⵏ ⵉⵎⵉⴽ", "now from now should display as in the past");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "ⴰⵙⴷⵅ ⴴ 12:00", "today at the same time");
