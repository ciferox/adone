...
describe("cy", () => {
    ...
    it("format ordinal", () => {
        assert.equal(adone.datetime([2011, 0, 1]).format("DDDo"), "1af", "1af");
        assert.equal(adone.datetime([2011, 0, 2]).format("DDDo"), "2il", "2il");
        assert.equal(adone.datetime([2011, 0, 3]).format("DDDo"), "3ydd", "3ydd");
        assert.equal(adone.datetime([2011, 0, 4]).format("DDDo"), "4ydd", "4ydd");
        assert.equal(adone.datetime([2011, 0, 5]).format("DDDo"), "5ed", "5ed");
        assert.equal(adone.datetime([2011, 0, 6]).format("DDDo"), "6ed", "6ed");
        assert.equal(adone.datetime([2011, 0, 7]).format("DDDo"), "7ed", "7ed");
        assert.equal(adone.datetime([2011, 0, 8]).format("DDDo"), "8fed", "8fed");
        assert.equal(adone.datetime([2011, 0, 9]).format("DDDo"), "9fed", "9fed");
        assert.equal(adone.datetime([2011, 0, 10]).format("DDDo"), "10fed", "10fed");

        assert.equal(adone.datetime([2011, 0, 11]).format("DDDo"), "11eg", "11eg");
        assert.equal(adone.datetime([2011, 0, 12]).format("DDDo"), "12fed", "12fed");
        assert.equal(adone.datetime([2011, 0, 13]).format("DDDo"), "13eg", "13eg");
        assert.equal(adone.datetime([2011, 0, 14]).format("DDDo"), "14eg", "14eg");
        assert.equal(adone.datetime([2011, 0, 15]).format("DDDo"), "15fed", "15fed");
        assert.equal(adone.datetime([2011, 0, 16]).format("DDDo"), "16eg", "16eg");
        assert.equal(adone.datetime([2011, 0, 17]).format("DDDo"), "17eg", "17eg");
        assert.equal(adone.datetime([2011, 0, 18]).format("DDDo"), "18fed", "18fed");
        assert.equal(adone.datetime([2011, 0, 19]).format("DDDo"), "19eg", "19eg");
        assert.equal(adone.datetime([2011, 0, 20]).format("DDDo"), "20fed", "20fed");

        assert.equal(adone.datetime([2011, 0, 21]).format("DDDo"), "21ain", "21ain");
        assert.equal(adone.datetime([2011, 0, 22]).format("DDDo"), "22ain", "22ain");
        assert.equal(adone.datetime([2011, 0, 23]).format("DDDo"), "23ain", "23ain");
        assert.equal(adone.datetime([2011, 0, 24]).format("DDDo"), "24ain", "24ain");
        assert.equal(adone.datetime([2011, 0, 25]).format("DDDo"), "25ain", "25ain");
        assert.equal(adone.datetime([2011, 0, 26]).format("DDDo"), "26ain", "26ain");
        assert.equal(adone.datetime([2011, 0, 27]).format("DDDo"), "27ain", "27ain");
        assert.equal(adone.datetime([2011, 0, 28]).format("DDDo"), "28ain", "28ain");
        assert.equal(adone.datetime([2011, 0, 29]).format("DDDo"), "29ain", "29ain");
        assert.equal(adone.datetime([2011, 0, 30]).format("DDDo"), "30ain", "30ain");

        assert.equal(adone.datetime([2011, 0, 31]).format("DDDo"), "31ain", "31ain");
    });
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "mewn ychydig eiliadau", "prefix");
        assert.equal(adone.datetime(0).from(30000), "ychydig eiliadau yn ôl", "suffix");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "Heddiw am 12:00", "today at the same time");
    ...
    it("weeks year starting sunday formatted", () => {
        assert.equal(adone.datetime([2012, 0, 1]).format("w ww wo"), "52 52 52ain", "Jan  1 2012 should be week 52");
        assert.equal(adone.datetime([2012, 0, 2]).format("w ww wo"), "1 01 1af", "Jan  2 2012 should be week 1");
        assert.equal(adone.datetime([2012, 0, 8]).format("w ww wo"), "1 01 1af", "Jan  8 2012 should be week 1");
        assert.equal(adone.datetime([2012, 0, 9]).format("w ww wo"), "2 02 2il", "Jan  9 2012 should be week 2");
        assert.equal(adone.datetime([2012, 0, 15]).format("w ww wo"), "2 02 2il", "Jan 15 2012 should be week 2");
    });
});
