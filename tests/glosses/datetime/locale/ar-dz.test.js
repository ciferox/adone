...
describe("datetime", "locale", "ar-dz", () => {
    ...
    it("weeks year starting sunday formatted", () => {
        assert.equal(adone.datetime([2016, 1, 4]).format("w ww wo"), "5 05 5", "Feb 4 2016 should be week 5");
        assert.equal(adone.datetime([2016, 0, 6]).format("w ww wo"), "1 01 1", "Jan  6 2016 should be week 1");
        assert.equal(adone.datetime([2016, 0, 7]).format("w ww wo"), "1 01 1", "Jan  7 2016 should be week 1");
        assert.equal(adone.datetime([2016, 0, 13]).format("w ww wo"), "2 02 2", "Jan 13 2016 should be week 2");
        assert.equal(adone.datetime([2016, 0, 14]).format("w ww wo"), "2 02 2", "Jan 14 2016 should be week 2");
    });
});
