...
describe("nb", () => {
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "om noen sekunder", "prefix");
        assert.equal(adone.datetime(0).from(30000), "noen sekunder siden", "suffix");
    });

    it("now from now", () => {
        assert.equal(adone.datetime().fromNow(), "noen sekunder siden", "now from now should display as in the past");
    });
