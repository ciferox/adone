...
describe("is", () => {
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "eftir nokkrar sekúndur", "prefix");
        assert.equal(adone.datetime(0).from(30000), "fyrir nokkrum sekúndum síðan", "suffix");
    ...
    it("now from now", () => {
        assert.equal(adone.datetime().fromNow(), "fyrir nokkrum sekúndum síðan", "now from now should display as in the past");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "í dag kl. 12:00", "today at the same time");
