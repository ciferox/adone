...
describe("tlh", () => {
    ...
    */
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "puS lup pIq", "suffix");
        assert.equal(adone.datetime(0).from(30000), "puS lup ret", "suffix");
    });

    it("now from now", () => {
        assert.equal(adone.datetime().fromNow(), "puS lup ret", "now from now should display as in the past");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "DaHjaj 12:00", "today at the same time");
