...
describe("cs", () => {
    ...
    it("suffix", () => {
        assert.equal(adone.datetime(30000).from(0), "za pár sekund", "prefix");
        assert.equal(adone.datetime(0).from(30000), "před pár sekundami", "suffix");
    });

    it("now from now", () => {
        assert.equal(adone.datetime().fromNow(), "před pár sekundami", "now from now should display as in the past");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.datetime(a).calendar(), "dnes v 12:00", "today at the same time");
    ...
    it("humanize duration", () => {
        assert.equal(adone.datetime.duration(1, "minutes").humanize(), "minuta", "a minute (future)");
        assert.equal(adone.datetime.duration(1, "minutes").humanize(true), "za minutu", "in a minute");
        assert.equal(adone.datetime.duration(-1, "minutes").humanize(), "minuta", "a minute (past)");
        assert.equal(adone.datetime.duration(-1, "minutes").humanize(true), "před minutou", "a minute ago");
    });
