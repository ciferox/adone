...
const AutoComplete = require(srcPath("prompts/autocomplete"));
let prompt;
            ...
            prompt = new Prompt({
                ...
                async suggest(input, choices = []) {
                    return new Promise(async (resolve) => {
                        ...
                        const list = pending.filter((str) => str.startsWith(input));
                        const items = await Promise.all(await this.toChoices(list));
