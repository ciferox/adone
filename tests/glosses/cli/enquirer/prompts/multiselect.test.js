...
describe("multiselect", () => {
    ...
    describe("options.initial", () => {
        ...
        it("should not render the initial value on the prompt line", (cb) => {
            ...
            prompt.once("run", async () => {
                const init = colors.unstyle([prompt.symbols.pointer, prompt.options.initial].join(" "));
                await prompt.render();
                try {
                    const buf = colors.unstyle(prompt.state.buffer);
    ...
    describe("rendering", () => {
        it("should render a choice with the correct styles", (cb) => {
            ...
            prompt.on("run", async () => {
                assert(is.array(prompt.choices));
