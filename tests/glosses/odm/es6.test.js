...
describe("bug fixes", () => {
    ...
    it("discriminators with classes modifies class in place (gh-5175)", (done) => {
    ...
    it("allows overwriting base class methods (gh-5227)", (done) => {
    ...
    it("supports adding properties (gh-5104) (gh-5635)", (done) => {
