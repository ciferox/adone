...
describe("model: querying:", () => {
    ...
    describe("findOne", () => {
        ...
        it("using #all with nested #elemMatch", (done) => {
            var db = start(),
    ...
    describe("findById", () => {
        ...
        it("where an array where the $slice operator", (done) => {
            var db = start(),
                BlogPostB = db.model('BlogPostB', collection);
    ...
    describe("find", () => {
        ...
        it("a document whose arrays contain at least $all string values", (done) => {
            var db = start(),
                BlogPostB = db.model('BlogPostB', collection);
        ...
        it("using #nor with nested #elemMatch", (done) => {
            var db = start(),
        ...
        it("a document whose arrays contain at least $all values", (done) => {
            var db = start(),
                BlogPostB = db.model('BlogPostB', collection);
    ...
    describe("$all", () => {
        ...
        it("with Dates", function (done) {
            ...
            let SSchema = new Schema({ d: Date });
            let PSchema = new Schema({ sub: [SSchema] });

            let P = db.model("usingAllWithDates", PSchema);
            let sub = [
                { d: new Date() },
        ...
        it("with $elemMatch (gh-3163)", (done) => {
            var db = start();
    ...
    it("with conditionals", (done) => {
        ...
        let docA = { name: "A", block: new MongooseBuffer([195, 188, 98, 101, 114]) }; // über
        let docB = { name: "B", block: new MongooseBuffer("buffer shtuffs are neat") };
        let docC = { name: "C", block: new MongooseBuffer("aGVsbG8gd29ybGQ=", "base64") };
    ...
    it("with unused values in the db", (done) => {
        let db = start(),
            BlogPostB = db.model("BlogPostB", collection),
            post = new BlogPostB();

        post.collection.insert({ meta: { visitors: 9898, color: "blue" } }, {}, (err, b) => {
            assert.ifError(err);
    ...
    describe("2d", () => {
        ...
        it("$nearSphere with arrays (gh-610)", (done) => {
            var db = start(),
        ...
        it("$nearSphere with invalid coordinate does not crash (gh-1874)", (done) => {
        ...
        it("$maxDistance with arrays", (done) => {
            var db = start(),
    ...
    describe("2dsphere", () => {
        ...
        it("index is allowed in schema", (done) => {
            if (!mongo24_or_greater) {
                return done();
            }
    ...
    describe("lean", () => {
        ...
        it("casts $elemMatch (gh-2199)", (done) => {
            var db = start();
