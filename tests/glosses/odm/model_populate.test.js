...
describe("model: populate:", () => {
    ...
    it("populating array of object", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);

        User.create({ name: "User 1" }, (err, user1) => {
            assert.ifError(err);
    ...
    it("deep population (gh-3103)", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);

        User.create({ name: "User 01" }, (err, user1) => {
            assert.ifError(err);
    ...
    describe("deep populate", () => {
        ...
        it("deep population with refs (gh-3507)", (done) => {
            // handler schema
        ...
        it("multiple paths with same options (gh-3808)", (done) => {
    ...
    it("populating a single ref", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);
    ...
    it("not failing on null as ref", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts);
    ...
    it("not failing on empty object as ref", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts);
    ...
    it("populating with partial fields selection", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);
    ...
    it("population of single oid with partial field selection and filter", (done) => {
        let db = start(),
    ...
    it("population of undefined fields in a collection of docs", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", "blogposts_" + random()),
            User = db.model("RefUser", "users_" + random());
        User.create({
    ...
    it("undefined for nested paths (gh-3859)", (done) => {
        let db = start();
        ...
        let Company = db.model("gh3859_0", companySchema);
        let User = db.model("gh3859_1", userSchema);
        let Sample = db.model("gh3859_2", sampleSchema);

        let company = new Company({ name: "Reynholm Industrie" });
        let user1 = new User({ name: "Douglas", company: company._id });
        let user2 = new User({ name: "Lambda" });
    ...
    it("population and changing a reference", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);
    ...
    it("populating with partial fields selection and changing ref", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);
    ...
    it("populating an array of refs and fetching many", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);
    ...
    it("populating an array of references with fields selection", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);
    ...
    it("populating an array of references and filtering", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);
    ...
    it("populating an array of references and multi-filtering", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);
    ...
    it("populating an array of references and multi-filtering with field selection", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);
    ...
    it("populating an array of refs changing one and removing one", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);
    ...
    describe("populating sub docs", () => {
        it("works with findById", (done) => {
            var db = start(),
                BlogPost = db.model('RefBlogPost', posts),
                User = db.model('RefUser', users);
        ...
        it("works when first doc returned has empty array for populated path (gh-1055)", (done) => {
            var db = start(),
                BlogPost = db.model('RefBlogPost', posts),
                User = db.model('RefUser', users);
    ...
    it("clears cache when array has been re-assigned (gh-2176)", (done) => {
        let db = start();
        let BlogPost = db.model("RefBlogPost", posts, "gh-2176-1");
        let User = db.model("RefUser", users, "gh-2176-2");

        User.create({ name: "aaron" }, { name: "val" }, (err, user1, user2) => {
            assert.ifError(err);
    ...
    it("populating subdocuments partially", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);
    ...
    it("populating subdocuments partially with conditions", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);
    ...
    it("populating subdocs with invalid/missing subproperties", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);
    ...
    it("properly handles limit per document (gh-2151)", (done) => {
        let db = start();
        ...
        let User = db.model("gh-2151-1", user, "gh-2151-1");
        ...
        let BlogPost = db.model("gh-2151-2", blogpost, "gh-2151-2");

        let userIds = [new ObjectId(), new ObjectId(), new ObjectId(), new ObjectId()];
        let users = [];
    ...
    it("populating subdocuments partially with empty array (gh-481)", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts);
    ...
    it("populating subdocuments partially with null array", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts);
    ...
    it("populating subdocuments with array including nulls", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);

        let user = new User({ name: "hans zimmer" });
        user.save((err) => {
            assert.ifError(err);
    ...
    it("populating more than one array at a time", (done) => {
        let db = start(),
            User = db.model("RefUser", users),
    ...
    it("populating multiple children of a sub-array at a time", (done) => {
        let db = start(),
            User = db.model("RefUser", users),
            BlogPost = db.model("RefBlogPost", posts),
            Inner = new Schema({
        ...
        let M = db.model("PopMultiChildrenOfSubDoc", new Schema({
            kids: [Inner]
        }));
    ...
    it("passing sort options to the populate method", (done) => {
        let db = start(),
    ...
    it("limit should apply to each returned doc, not in aggregate (gh-1490)", (done) => {
        let db = start();
        let sB = new Schema({
            name: String
        });
        ...
        let B = db.model(name, sB);
        let J = db.model("j" + random(), sJ);

        let b1 = new B({ name: "thing1" });
        let b2 = new B({ name: "thing2" });
        let b3 = new B({ name: "thing3" });
        let b4 = new B({ name: "thing4" });
        let b5 = new B({ name: "thing5" });

        let j1 = new J({ b: [b1.id, b2.id, b5.id] });
        let j2 = new J({ b: [b3.id, b4.id, b5.id] });
        ...
        function next() {
            J.find().populate({ path: "b", options: { limit: 2 } }).exec((err, j) => {
    ...
    it("refs should cast to ObjectId from hexstrings", (done) => {
        let BP = mongoose.model("RefBlogPost", BlogPost);
        let bp = new BP();
    ...
    it("populate should work on String _ids", (done) => {
        let db = start();
        ...
        let User = db.model("UserWithStringId", UserSchema, random());
        let Note = db.model("NoteWithStringId", NoteSchema, random());

        let alice = new User({ _id: "alice", name: "Alice" });
    ...
    it("populate should work on Number _ids", (done) => {
        let db = start();
        ...
        let User = db.model("UserWithNumberId", UserSchema, random());
        let Note = db.model("NoteWithNumberId", NoteSchema, random());

        let alice = new User({ _id: 2359, name: "Alice" });
    ...
    it("required works on ref fields (gh-577)", (done) => {
        let db = start();

        let userSchema = new Schema({
            email: { type: String, required: true }
        });
        let User = db.model("ObjectIdRefRequiredField", userSchema, random());

        let numSchema = new Schema({ _id: Number, val: Number });
        let Num = db.model("NumberRefRequired", numSchema, random());

        let strSchema = new Schema({ _id: String, val: String });
        let Str = db.model("StringRefRequired", strSchema, random());
        ...
        let Comment = db.model("CommentWithRequiredField", commentSchema);

        let pending = 3;

        let string = new Str({ _id: "my string", val: "hello" });
        let number = new Num({ _id: 1995, val: 234 });
    ...
    it("populate works with schemas with both id and _id defined", (done) => {
        let db = start(),
            S1 = new Schema({ id: String }),
            S2 = new Schema({ things: [{ type: ObjectId, ref: "_idAndid" }] });

        let M1 = db.model("_idAndid", S1);
        let M2 = db.model("populateWorksWith_idAndidSchemas", S2);
    ...
    it("Update works with populated arrays (gh-602)", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);

        User.create({ name: "aphex" }, { name: "twin" }, (err, u1, u2) => {
            assert.ifError(err);
    ...
    it("toJSON should also be called for refs (gh-675)", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
            User = db.model("RefUser", users);
    ...
    it("populate should work on Buffer _ids (gh-686)", (done) => {
        let db = start();
        ...
        let User = db.model("UserWithBufferId", UserSchema, random());
        let Note = db.model("NoteWithBufferId", NoteSchema, random());

        let alice = new User({ _id: new mongoose.Types.Buffer("YWxpY2U=", "base64"), name: "Alice" });
    ...
    it("populated Buffer _ids should be requireable", (done) => {
        let db = start();
    ...
    it("populating with custom model selection (gh-773)", (done) => {
        let db = start(),
            BlogPost = db.model("RefBlogPost", posts),
    ...
    describe("specifying a custom model without specifying a ref in schema", () => {
        it("with String _id", (done) => {
            var db = start();
    ...
    describe("specifying all params using an object", () => {
        let db, B, User;
        let post;
    ...
    describe("Model.populate()", () => {
        ...
        describe("of individual document", () => {
        ...
        describe("a document already populated", () => {
        ...
        describe("of multiple documents", () => {
            it('works', function (done) {
                B.findById(post1._id, function (error, post1) {
                    assert.ifError(error);
    ...
    describe("populating combined with lean (gh-1260)", () => {
        it("with findOne", (done) => {
            var db = start(),
    ...
    describe("records paths and _ids used in population", () => {
        let db;
        let B;
        let U;
        let u1, u2;
    ...
    describe("deselecting _id", () => {
        ...
        describe("of documents being populated", () => {
    ...
    describe("DynRef", () => {
        ...
        it("array with empty refPath (gh-5377)", (done) => {
        ...
        it("with non-arrays (gh-5114)", (done) => {
    ...
    describe("leaves Documents within Mixed properties alone (gh-1471)", () => {
        let db;
        let Cat;
        let Litter;
        ...
        it("when saving existing docs 5T5", (done) => {
        ...
        function confirm(done) {
            return function (err, litter) {
                ...
                Litter.findById(litter).lean().exec((err, doc) => {
                    if (err) {
                        return done(err);
                    }
                    assert.ok(doc.o._id);
    ...
    describe("github issues", () => {
        ...
        it("populating an array of refs, slicing, and fetching many (gh-5737)", (done) => {
        ...
        it("populate + slice (gh-5737a)", (done) => {
        ...
        it("maps results back to correct document (gh-1444)", (done) => {
        ...
        it("fails if sorting with a doc array subprop (gh-2202)", (done) => {
        ...
        it("handles toObject() (gh-3279)", (done) => {
        ...
        it("populate option (gh-2321)", (done) => {
        ...
        it("discriminator child schemas (gh-3878)", (done) => {
        ...
        it("set to obj w/ same id doesnt mark modified (gh-3992)", (done) => {
        ...
        it("deep populate single -> array (gh-3904)", (done) => {
            var personSchema = new Schema({
                name: { type: String }
            });
        ...
        it("deep populate array -> array (gh-3954)", (done) => {
            var personSchema = new Schema({
                name: { type: String }
            });
        ...
        it("4 level population (gh-3973)", (done) => {
        ...
        it("deep populate two paths (gh-3974)", (done) => {
            var level3Schema = new Schema({
                name: { type: String }
            });
        ...
        it("out-of-order discriminators (gh-4073)", (done) => {
            var UserSchema = new Schema({
                name: String
            });
        ...
        it("returned array has toObject() (gh-4656)", (done) => {
        ...
        it("empty populate string is a no-op (gh-4702)", (done) => {
            var BandSchema = new Schema({
                people: [{
                    type: mongoose.Schema.Types.ObjectId
                }]
        ...
        it("checks field name correctly with nested arrays (gh-4365)", (done) => {
        ...
        describe("populate virtuals (gh-2562)", () => {
