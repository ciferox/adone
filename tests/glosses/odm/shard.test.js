...
//     it("can read and write to a shard", (done) => {
...
//     it("save() and remove() works with shard keys transparently", (done) => {
//         var db = start({ uri: uri });
//         var P = db.model('ShardPerson', collection);
...
//     it("inserting to a sharded collection without the full shard key fails", (done) => {
//         var db = start({ uri: uri });
//         var P = db.model('ShardPerson', collection);
...
//     it("updating a sharded collection without the full shard key fails", (done) => {
//         var db = start({ uri: uri });
//         var P = db.model('ShardPerson', collection);
...
//     it("updating shard key values fails", (done) => {
//         var db = start({ uri: uri });
//         var P = db.model('ShardPerson', collection);
...
//     it("allows null shard key values", (done) => {
//         var db = start({ uri: uri });
//         var P = db.model('ShardPerson', collection);
