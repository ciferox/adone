...
describe("schema", () => {
    describe("validation", () => {
        it("invalid arguments are rejected (1044)", (done) => {
            assert.throws(() => {
                new Schema({
        ...
        it("string enum", (done) => {
            ...
            Test.path("complex").doValidate("x", (err) => {
                assert.ok(err instanceof ValidatorError);
            });

            // allow unsetting enums
            Test.path("complex").doValidate(undefined, (err) => {
                assert.ifError(err);
            });

            Test.path("complex").doValidate(null, (err) => {
                assert.ifError(err);
            });

            Test.path("complex").doValidate("da", (err) => {
                assert.ok(err instanceof ValidatorError);
            });

            Test.path("state").doValidate("x", (err) => {
                assert.ok(err instanceof ValidatorError);
                assert.equal(err.message,
                    "enum validator failed for path `state`: test");
            });

            Test.path("state").doValidate("opening", (err) => {
                assert.ifError(err);
            });

            Test.path("state").doValidate("open", (err) => {
                assert.ifError(err);
            });
        ...
        it("string regexp", (done) => {
            ...
            Test.path("simple").doValidate("az", (err) => {
                assert.ifError(err);
            });
            ...
            Test.path("simple").doValidate("12", (err) => {
                assert.ok(err instanceof ValidatorError);
            });

            Test.path("simple").doValidate("a12", (err) => {
                assert.ifError(err);
            });

            Test.path("simple").doValidate("", (err) => {
                assert.ifError(err);
            });
            Test.path("simple").doValidate(null, (err) => {
                assert.ifError(err);
            });
            Test.path("simple").doValidate(undefined, (err) => {
                assert.ifError(err);
            });
            Test.path("simple").validators = [];
            Test.path("simple").match(/[1-9]/);
            Test.path("simple").doValidate(0, (err) => {
                assert.ok(err instanceof ValidatorError);
            });
        ...
        describe("non-required fields", () => {
            describe("are validated correctly", () => {
                let db, Person;
            ...
            it("number min and max", (done) => {
                ...
                Tobi.path("friends").doValidate(10, (err) => {
                    assert.ifError(err);
                });
                ...
                // null is allowed
                Tobi.path("friends").doValidate(null, (err) => {
                    assert.ifError(err);
                });
        ...
        describe("required", () => {
            it("string required", (done) => {
                ...
                Test.path("simple").doValidate("woot", (err) => {
                    assert.ifError(err);
                });
            ...
            it("number required", (done) => {
                ...
                Edwald.path("friends").doValidate(null, (err) => {
                    assert.ok(err instanceof ValidatorError);
                });

                Edwald.path("friends").doValidate(undefined, (err) => {
                    assert.ok(err instanceof ValidatorError);
                });

                Edwald.path("friends").doValidate(0, (err) => {
                    assert.ifError(err);
                });
            ...
            it("date required", (done) => {
                ...
                Loki.path("birth_date").doValidate(null, (err) => {
                    assert.ok(err instanceof ValidatorError);
                });

                Loki.path("birth_date").doValidate(undefined, (err) => {
                    assert.ok(err instanceof ValidatorError);
                });

                Loki.path("birth_date").doValidate(new Date(), (err) => {
                    assert.ifError(err);
                });
            ...
            it("date not empty string (gh-3132)", (done) => {
                ...
                HappyBirthday.path("date").doValidate("", (err) => {
                    assert.ok(err instanceof ValidatorError);
                    done();
                });
            });
            ...
            it("objectid required", (done) => {
                ...
                Loki.path("owner").doValidate(new DocumentObjectId(), (err) => {
                    assert.ifError(err);
                });

                Loki.path("owner").doValidate(null, (err) => {
                    assert.ok(err instanceof ValidatorError);
                });

                Loki.path("owner").doValidate(undefined, (err) => {
                    assert.ok(err instanceof ValidatorError);
                });
                done();
            });
            ...
            it("array required", (done) => {
                ...
                Loki.path("likes").doValidate(null, (err) => {
                    assert.ok(err instanceof ValidatorError);
                });

                Loki.path("likes").doValidate(undefined, (err) => {
                    assert.ok(err instanceof ValidatorError);
                });

                Loki.path("likes").doValidate([], (err) => {
                    assert.ok(err instanceof ValidatorError);
                });
                done();
            });
            ...
            it("boolean required", (done) => {
                ...
                Animal.path("isFerret").doValidate(null, (err) => {
                    assert.ok(err instanceof ValidatorError);
                });

                Animal.path("isFerret").doValidate(undefined, (err) => {
                    assert.ok(err instanceof ValidatorError);
                });

                Animal.path("isFerret").doValidate(true, (err) => {
                    assert.ifError(err);
                });

                Animal.path("isFerret").doValidate(false, (err) => {
                    assert.ifError(err);
                });
                done();
            });
            ...
            it("mixed required", (done) => {
                ...
                Animal.path("characteristics").doValidate(null, (err) => {
                    assert.ok(err instanceof ValidatorError);
                });

                Animal.path("characteristics").doValidate(undefined, (err) => {
                    assert.ok(err instanceof ValidatorError);
                });
                ...
                Animal.path("characteristics").doValidate("none available", (err) => {
                    assert.ifError(err);
                });
                done();
            });
        ...
        describe("async", () => {
            it("works", (done) => {
                ...
                Animal.path("ferret").doValidate(true, (err) => {
                    assert.ifError(err);
                });

                Animal.path("ferret").doValidate(false, (err) => {
        ...
        describe("types", () => {
            describe("are customizable", () => {
                it("for single custom validators", (done) => {
                    function validate() {
                        return false;
                    }
                ...
                it("for many custom validators", (done) => {
                    function validate() {
                        return false;
                    }
        ...
        it("should clear validator errors (gh-2302)", (done) => {
        ...
        it("should allow an array of enums (gh-661)", (done) => {
        ...
        it("should allow an array of subdocuments with enums (gh-3521)", (done) => {
        ...
        it("should validate subdocuments subproperty enums (gh-4111)", (done) => {
        ...
        it("doesnt do double validation on document arrays (gh-2618)", (done) => {
        ...
        it("doesnt do double validation on document arrays underneath nested (gh-5411)", (done) => {
            const callScope = [];
        ...
        it("no double validation on set nested docarray (gh-4145)", (done) => {
            let calls = 0;
        ...
        it("handles multiple subdocument errors (gh-2589)", (done) => {
        ...
        it("handles subdocument cast errors (gh-2819)", (done) => {
        ...
        it("fails when you try to set a nested path to a primitive (gh-2592)", (done) => {
        ...
        it("doesnt execute other validators if required fails (gh-2725)", (done) => {
        ...
        it("doesnt execute other validators if required fails (gh-3025)", (done) => {
            const breakfast = new Schema({ description: { type: String, required: true, maxlength: 50 } });
        ...
        it("validateSync allows you to filter paths (gh-3153)", (done) => {
        ...
        it("adds required validators to the front of the list (gh-2843)", (done) => {
