...
describe("A default buffer.ReadableStream", () => {
    let bs;
...
describe("A buffer.ReadableStream using custom chunk size", () => {
    let bs;
    let data;
...
describe("A buffer.ReadableStream using custom frequency", () => {
    let bs;
    let time;
...
describe("buffer.WritableStream with defaults", () => {
    let bs;
...
describe("buffer.WritableStream with a different initial size and increment amount", () => {
    let bs;
...
describe("When buffer.WritableStream is written in two chunks", () => {
    let bs;
    beforeEach(() => {
        bs = new WritableStream();
        bs.write(fixtures.simpleString);
