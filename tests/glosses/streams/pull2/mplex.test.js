...
const { abortable, defer, pushable, through2, lengthPrefixed, mplex, pair } = pull;

const srcPath = (...args) => adone.std.path.join(adone.ROOT_PATH, "lib", "glosses", "streams", "pull2", ...args);

const coder = require(srcPath("mplex", "coder"));
const Plex = require(srcPath("mplex", "mplex"));

const noop = () => { };

describe("stream", "pull", "mplex", () => {
    ...
    describe("compliance", () => {
        const tests = require("../../p2p/interface_stream_muxer");
