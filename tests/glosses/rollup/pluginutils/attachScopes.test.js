const {
    rollup: { pluginutils: { attachScopes } }
} = adone;

describe("attachScopes", () => {
    it("attaches a scope to the top level", () => {
        const ast = {
            type: "Program",
            start: 0,
            end: 8,
    ...
    it("adds multiple declarators from a single var declaration", () => {
        const ast = {
            type: "Program",
            start: 0,
            end: 13,
    ...
    it("adds named declarators from a deconstructed declaration", () => {
        const ast = {
            type: "Program",
            start: 0,
            end: 13,
    ...
    it("adds rest elements from a deconstructed object declaration", () => {
        const ast = {
            type: "Program",
            start: 0,
            end: 66,
    ...
    it("adds nested declarators from a deconstructed declaration", () => {
        const ast = {
            type: "Program",
            start: 0,
            end: 40,
    ...
    it("supports FunctionDeclarations without id", () => {
        const ast = {
            type: "Program",
            start: 0,
            end: 33,
