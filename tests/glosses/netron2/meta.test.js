...
describe("meta", () => {
    ...
    describe.only("contextify()", () => {
        ...
        it("contextify class is not allowed", () => {
            assert.throws(() => adone.netron2.contextify(Simple), adone.error.NotValid);
        });
        ...
        it("contextify already contextified class", () => {
            ...
            assert.throws(() => adone.netron2.contextify(new MyContext()), adone.error.NotValid);
        });

        it("contextify instance of regular class", async () => {
            const instance = new Simple();

            const r = Reflection.from(adone.netron2.contextify(instance));
