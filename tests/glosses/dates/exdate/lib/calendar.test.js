...
describe("calendar", () => {
    ...
    it("extending calendar options", () => {
        const calendarFormat = adone.date.calendarFormat;

        adone.date.calendarFormat = function (myMoment, now) {
        ...
        const a = adone.date("2016-01-01").add(28, "days");
        const b = adone.date("2016-01-01").add(1, "month");
        try {
            ...
            adone.date.calendarFormat = calendarFormat;
            adone.date.updateLocale("en", null);
        }
    });
});
