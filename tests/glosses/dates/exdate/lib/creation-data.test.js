describe("creation data", () => {
    ...
    it("valid date", () => {
        const dat = adone.date("1992-10-22");
    ...
    it("valid date at fr locale", () => {
        const dat = adone.date("1992-10-22", "YYYY-MM-DD", "fr");
        const orig = dat.creationData();
    ...
    it("valid date with formats", () => {
        const dat = adone.date("29-06-1995", ["MM-DD-YYYY", "DD-MM", "DD-MM-YYYY"]);
        const orig = dat.creationData();
    ...
    it("strict", () => {
        assert.ok(adone.date("2015-01-02", "YYYY-MM-DD", true).creationData().strict, "strict is true");
        assert.ok(!adone.date("2015-01-02", "YYYY-MM-DD").creationData().strict, "strict is true");
    });
});
