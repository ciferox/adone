...
describe("pt-br", () => {
    ...
    it("format ordinal", () => {
        assert.equal(adone.date([2011, 0, 1]).format("DDDo"), "1º", "1º");
        assert.equal(adone.date([2011, 0, 2]).format("DDDo"), "2º", "2º");
        assert.equal(adone.date([2011, 0, 3]).format("DDDo"), "3º", "3º");
        assert.equal(adone.date([2011, 0, 4]).format("DDDo"), "4º", "4º");
        assert.equal(adone.date([2011, 0, 5]).format("DDDo"), "5º", "5º");
        assert.equal(adone.date([2011, 0, 6]).format("DDDo"), "6º", "6º");
        assert.equal(adone.date([2011, 0, 7]).format("DDDo"), "7º", "7º");
        assert.equal(adone.date([2011, 0, 8]).format("DDDo"), "8º", "8º");
        assert.equal(adone.date([2011, 0, 9]).format("DDDo"), "9º", "9º");
        assert.equal(adone.date([2011, 0, 10]).format("DDDo"), "10º", "10º");

        assert.equal(adone.date([2011, 0, 11]).format("DDDo"), "11º", "11º");
        assert.equal(adone.date([2011, 0, 12]).format("DDDo"), "12º", "12º");
        assert.equal(adone.date([2011, 0, 13]).format("DDDo"), "13º", "13º");
        assert.equal(adone.date([2011, 0, 14]).format("DDDo"), "14º", "14º");
        assert.equal(adone.date([2011, 0, 15]).format("DDDo"), "15º", "15º");
        assert.equal(adone.date([2011, 0, 16]).format("DDDo"), "16º", "16º");
        assert.equal(adone.date([2011, 0, 17]).format("DDDo"), "17º", "17º");
        assert.equal(adone.date([2011, 0, 18]).format("DDDo"), "18º", "18º");
        assert.equal(adone.date([2011, 0, 19]).format("DDDo"), "19º", "19º");
        assert.equal(adone.date([2011, 0, 20]).format("DDDo"), "20º", "20º");

        assert.equal(adone.date([2011, 0, 21]).format("DDDo"), "21º", "21º");
        assert.equal(adone.date([2011, 0, 22]).format("DDDo"), "22º", "22º");
        assert.equal(adone.date([2011, 0, 23]).format("DDDo"), "23º", "23º");
        assert.equal(adone.date([2011, 0, 24]).format("DDDo"), "24º", "24º");
        assert.equal(adone.date([2011, 0, 25]).format("DDDo"), "25º", "25º");
        assert.equal(adone.date([2011, 0, 26]).format("DDDo"), "26º", "26º");
        assert.equal(adone.date([2011, 0, 27]).format("DDDo"), "27º", "27º");
        assert.equal(adone.date([2011, 0, 28]).format("DDDo"), "28º", "28º");
        assert.equal(adone.date([2011, 0, 29]).format("DDDo"), "29º", "29º");
        assert.equal(adone.date([2011, 0, 30]).format("DDDo"), "30º", "30º");

        assert.equal(adone.date([2011, 0, 31]).format("DDDo"), "31º", "31º");
    });
    ...
    it("format week", () => {
        const expected = "Domingo Dom_Segunda-feira Seg_Terça-feira Ter_Quarta-feira Qua_Quinta-feira Qui_Sexta-feira Sex_Sábado Sáb".split("_");
        let i;
    ...
    it("suffix", () => {
        assert.equal(adone.date(30000).from(0), "em poucos segundos", "prefix");
        assert.equal(adone.date(0).from(30000), "poucos segundos atrás", "suffix");
    });
    ...
    it("calendar day", () => {
        ...
        assert.equal(adone.date(a).calendar(), "Hoje às 12:00", "today at the same time");
    ...
    it("weeks year starting sunday format", () => {
        assert.equal(adone.date([2012, 0, 1]).format("w ww wo"), "1 01 1º", "Jan  1 2012 should be week 1");
        assert.equal(adone.date([2012, 0, 7]).format("w ww wo"), "1 01 1º", "Jan  7 2012 should be week 1");
        assert.equal(adone.date([2012, 0, 8]).format("w ww wo"), "2 02 2º", "Jan  8 2012 should be week 2");
        assert.equal(adone.date([2012, 0, 14]).format("w ww wo"), "2 02 2º", "Jan 14 2012 should be week 2");
        assert.equal(adone.date([2012, 0, 15]).format("w ww wo"), "3 03 3º", "Jan 15 2012 should be week 3");
    });
});
