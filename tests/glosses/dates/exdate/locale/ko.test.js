...
describe("ko", () => {
    ...
    it("format ordinal", () => {
        assert.equal(adone.date([2011, 0, 1]).format("DDDo"), "1일", "1일");
        assert.equal(adone.date([2011, 0, 2]).format("DDDo"), "2일", "2일");
        assert.equal(adone.date([2011, 0, 3]).format("DDDo"), "3일", "3일");
        assert.equal(adone.date([2011, 0, 4]).format("DDDo"), "4일", "4일");
        assert.equal(adone.date([2011, 0, 5]).format("DDDo"), "5일", "5일");
        assert.equal(adone.date([2011, 0, 6]).format("DDDo"), "6일", "6일");
        assert.equal(adone.date([2011, 0, 7]).format("DDDo"), "7일", "7일");
        assert.equal(adone.date([2011, 0, 8]).format("DDDo"), "8일", "8일");
        assert.equal(adone.date([2011, 0, 9]).format("DDDo"), "9일", "9일");
        assert.equal(adone.date([2011, 0, 10]).format("DDDo"), "10일", "10일");

        assert.equal(adone.date([2011, 0, 11]).format("DDDo"), "11일", "11일");
        assert.equal(adone.date([2011, 0, 12]).format("DDDo"), "12일", "12일");
        assert.equal(adone.date([2011, 0, 13]).format("DDDo"), "13일", "13일");
        assert.equal(adone.date([2011, 0, 14]).format("DDDo"), "14일", "14일");
        assert.equal(adone.date([2011, 0, 15]).format("DDDo"), "15일", "15일");
        assert.equal(adone.date([2011, 0, 16]).format("DDDo"), "16일", "16일");
        assert.equal(adone.date([2011, 0, 17]).format("DDDo"), "17일", "17일");
        assert.equal(adone.date([2011, 0, 18]).format("DDDo"), "18일", "18일");
        assert.equal(adone.date([2011, 0, 19]).format("DDDo"), "19일", "19일");
        assert.equal(adone.date([2011, 0, 20]).format("DDDo"), "20일", "20일");

        assert.equal(adone.date([2011, 0, 21]).format("DDDo"), "21일", "21일");
        assert.equal(adone.date([2011, 0, 22]).format("DDDo"), "22일", "22일");
        assert.equal(adone.date([2011, 0, 23]).format("DDDo"), "23일", "23일");
        assert.equal(adone.date([2011, 0, 24]).format("DDDo"), "24일", "24일");
        assert.equal(adone.date([2011, 0, 25]).format("DDDo"), "25일", "25일");
        assert.equal(adone.date([2011, 0, 26]).format("DDDo"), "26일", "26일");
        assert.equal(adone.date([2011, 0, 27]).format("DDDo"), "27일", "27일");
        assert.equal(adone.date([2011, 0, 28]).format("DDDo"), "28일", "28일");
        assert.equal(adone.date([2011, 0, 29]).format("DDDo"), "29일", "29일");
        assert.equal(adone.date([2011, 0, 30]).format("DDDo"), "30일", "30일");

        assert.equal(adone.date([2011, 0, 31]).format("DDDo"), "31일", "31일");
    });
    ...
    it("suffix", () => {
        assert.equal(adone.date(30000).from(0), "몇 초 후", "prefix");
        assert.equal(adone.date(0).from(30000), "몇 초 전", "suffix");
    });

    it("now from now", () => {
        assert.equal(adone.date().fromNow(), "몇 초 전", "now from now should display as in the past");
    });
    ...
    it("weeks year starting sunday format", () => {
        assert.equal(adone.date([2012, 0, 1]).format("w ww wo"), "1 01 1일", "Jan  1 2012 should be week 1");
        assert.equal(adone.date([2012, 0, 7]).format("w ww wo"), "1 01 1일", "Jan  7 2012 should be week 1");
        assert.equal(adone.date([2012, 0, 8]).format("w ww wo"), "2 02 2일", "Jan  8 2012 should be week 2");
        assert.equal(adone.date([2012, 0, 14]).format("w ww wo"), "2 02 2일", "Jan 14 2012 should be week 2");
        assert.equal(adone.date([2012, 0, 15]).format("w ww wo"), "3 03 3일", "Jan 15 2012 should be week 3");
    });
});
