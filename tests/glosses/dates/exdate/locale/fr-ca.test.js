...
describe("fr-ca", () => {
    ...
    it("weeks year starting sunday formatted", () => {
        assert.equal(adone.date([2012, 0, 1]).format("w ww wo"), "1 01 1re", "Jan  1 2012 should be week 1");
        assert.equal(adone.date([2012, 0, 7]).format("w ww wo"), "1 01 1re", "Jan  7 2012 should be week 1");
