...
describe("fr-ca", () => {
    ...
    it("format ordinal", () => {
        ...
        assert.equal(adone.date([2011, 0, 21]).format("DDDo"), "21e", "21e");
        assert.equal(adone.date([2011, 0, 22]).format("DDDo"), "22e", "22e");
    ...
    it("suffix", () => {
        assert.equal(adone.date(30000).from(0), "dans quelques secondes", "prefix");
        assert.equal(adone.date(0).from(30000), "il y a quelques secondes", "suffix");
    });
    ...
    it("weeks year starting sunday format", () => {
        assert.equal(adone.date([2012, 0, 1]).format("w ww wo"), "1 01 1er", "Jan  1 2012 should be week 1");
        assert.equal(adone.date([2012, 0, 7]).format("w ww wo"), "1 01 1er", "Jan  7 2012 should be week 1");
        assert.equal(adone.date([2012, 0, 8]).format("w ww wo"), "2 02 2e", "Jan  8 2012 should be week 2");
        assert.equal(adone.date([2012, 0, 14]).format("w ww wo"), "2 02 2e", "Jan 14 2012 should be week 2");
        assert.equal(adone.date([2012, 0, 15]).format("w ww wo"), "3 03 3e", "Jan 15 2012 should be week 3");
    });
});
