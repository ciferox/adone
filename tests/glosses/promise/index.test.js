describe("promise", () => {
    ...
    describe("timeout", () => {
        it("should throw if the first argument is not a promise", () => {
            expect(() => {
                promise.timeout(5);
            }).to.throw(adone.error.InvalidArgumentException, "The first argument must be a promise");
        });
        ...
        it("should reject the promise after the dalay", async () => {
            ...
            expect(res).to.be.instanceOf(adone.error.TimeoutException);
        ...
        it("should work for synchronous code", async () => {
            ...
            expect(q).to.be.instanceOf(adone.error.TimeoutException);
