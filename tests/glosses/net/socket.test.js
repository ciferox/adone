    ...
    describe("insecure", function () {
        ...
        describe("Bind", () => {
            ...
            it("double bind error", async () => {
                ...
                assert(err instanceof adone.error.BindException);
                await checkBind(server, SERVER_PORT);
            });
        ...
        describe("Connect", () => {
            ...
            it("reconnect attempts", async () => {
                ...
                assert(err instanceof adone.error.ConnectException);
        ...
        describe("Stability", () => {
            ...
            it("client - write after self disconnect", async () => {
                ...
                assert(e instanceof adone.error.IllegalStateException);
