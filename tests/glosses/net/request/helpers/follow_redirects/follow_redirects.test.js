...
import followRedirects from "adone/glosses/net/request/helpers/follow_redirects";
...
describe("follow-redirects ", function () {
    ...
    it.skip("should allow aborting", function (done) {
        let request;
    ...
    describe.skip("should choose the right agent per protocol", function () {
        it("(https -> http -> https)", function (done) {
            app.get("/a", redirectsTo("http://localhost:3600/b"));
            app2.get("/b", redirectsTo("https://localhost:3601/c"));
            app.get("/c", sendsJson({ yes: "no" }));
