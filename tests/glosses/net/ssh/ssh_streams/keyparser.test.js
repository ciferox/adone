...
import { keyParser as parser } from "../../../../../lib/glosses/net/ssh/ssh_streams";
...
const tests = [{
    ...
    name: "Unencrypted RSA private key (OpenSSH format)"
}, {
    source: [
        " ",
        "-----BEGIN RSA PRIVATE KEY-----",
    ...
    name: "Unencrypted RSA private key (OpenSSH format) with surrounding whitespace"
}, {
    source: [
        "-----BEGIN RSA PRIVATE KEY-----",
    ...
    name: "Encrypted RSA private key (OpenSSH format)"
}, {
    ...
    name: "RSA public key (OpenSSH format)"
}, {
    ...
    name: "RSA public key with comment (OpenSSH format)"
}, {
    source: [
    ...
    name: "Unencrypted DSA private key (OpenSSH format)"
}, {
    source: [
        "-----BEGIN DSA PRIVATE KEY-----",
        "Proc-Type: 4,ENCRYPTED",
    ...
    name: "Encrypted DSA private key (OpenSSH format)"
}, {
    ...
    name: "DSA public key (OpenSSH format)"
}, {
    ...
    name: "DSA public key (OpenSSH format) with comment"
}, {
    ...
    name: "DSA public key (OpenSSH format) with comment (no spaces)"
}, {
    source: [
    ...
    name: "RSA public key (RFC4716 format) with quoted comment"
}, {
    source: [
        "---- BEGIN SSH2 PUBLIC KEY ----",
        "Comment: testing ssh2 from node.js",
    ...
    name: "RSA public key (RFC4716 format) with unquoted comment"
}, {
    source: [
        "---- BEGIN SSH2 PUBLIC KEY ----",
    ...
    name: "RSA public key (RFC4716 format) with multi-line quoted comment"
}, {
    source: [
        "---- BEGIN SSH2 PUBLIC KEY ----",
        "Comment: testing ssh2 \\",
    ...
    name: "RSA public key (RFC4716 format) with multi-line unquoted comment"
}, {
    source: [
        "---- BEGIN SSH2 PUBLIC KEY ----",
        "Comment: \"\"",
    ...
    name: "RSA public key (RFC4716 format) with empty quoted comment"
}, {
    source: [
        "---- BEGIN SSH2 PUBLIC KEY ----",
        "Comment: ",
    ...
    name: "RSA public key (RFC4716 format) with empty unquoted comment"
}, {
    source: [
        "---- BEGIN SSH2 PUBLIC KEY ----",
        "AAAAB3NzaC1yc2EAAAADAQABAAAAYQDl6dxL+hgxwGNhZrq18vArbNB0UqNxvclf+ociRL",
    ...
    name: "RSA public key (RFC4716 format) with no comment"
}, {
    source: [
        "---- BEGIN SSH2 PUBLIC KEY ----",
        "",
    ...
    name: "RSA public key (RFC4716 format) with blank lines"
}, {
    source: [
        "---- BEGIN SSH2 PUBLIC KEY ----",
    ...
    name: "Encrypted RSA key (PPK format)"
}, {
    source: [
    ...
    name: "Unencrypted DSA key (PPK format)"
}, {
    source: [
        "PuTTY-User-Key-File-2: ssh-dss",
        "Encryption: aes256-cbc",
    ...
    name: "Encrypted DSA key (PPK format)"
}];
