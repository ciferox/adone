    ...
    describe("Utils", () => {
        ...
        it("decryptKey - with encrypted RSA", (done) => {
            ...
            assert(keyInfo._converted === undefined,
                "Unexpected automatic private PEM generation");
            assert(keyInfo._macresult === undefined,
                "Unexpected MAC verification");
            assert(keyInfo._decrypted === true,
                "Expected decrypted flag");
            assert.deepEqual(keyInfo.private,
                expPriv,
                "Decrypted private data mismatch");
            assert.deepEqual(keyInfo.privateOrig,
                expPrivOrig,
                "Decrypted private PEM data mismatch");
            done();
