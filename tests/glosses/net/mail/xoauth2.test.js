...
describe("glosses", "net", "mail", "XOAuth2 tests", function () {
    ...
    it("should get an existing access token", (done) => {
    ...
    it("should get an existing access token, no timeout", (done) => {
        const xoauth2 = new XOAuth2({
            user: "test@example.com",
            clientId: "{Client ID}",
            clientSecret: "{Client Secret}",
    ...
    it("should generate a fresh access token", (done) => {
        const xoauth2 = new XOAuth2({
            user: "test@example.com",
            clientId: "{Client ID}",
            clientSecret: "{Client Secret}",
    ...
    it("should generate a fresh access token with custom method", (done) => {
        const xoauth2 = new XOAuth2({
            user: "test@example.com",
            clientId: "{Client ID}",
            clientSecret: "{Client Secret}",
    ...
    it("should fail generating a fresh access token with custom method", (done) => {
        const xoauth2 = new XOAuth2({
            user: "test@example.com",
            clientId: "{Client ID}",
            clientSecret: "{Client Secret}",
    ...
    it("should generate a fresh access token after timeout", (done) => {
        const xoauth2 = new XOAuth2({
            user: "test@example.com",
            clientId: "{Client ID}",
            clientSecret: "{Client Secret}",
    ...
    it("should emit access token update", (done) => {
        const xoauth2 = new XOAuth2({
            user: "test@example.com",
            clientId: "{Client ID}",
            clientSecret: "{Client Secret}",
