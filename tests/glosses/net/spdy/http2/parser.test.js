...
describe("HTTP2 Parser", () => {
    ...
    describe("SETTINGS", () => {
        it("should parse regular frame", (done) => {
        ...
        it("should parse ACK", (done) => {
            pass("000000040100000000", {
                type: "ACK_SETTINGS"
            }, done);
        });

        it("should fail on non-empty ACK", (done) => {
            fail("000001040100000000ff", "FRAME_SIZE_ERROR", /ACK.*non-zero/i, done);
        });

        it("should fail on non-aligned frame", (done) => {
            fail("000001040000000000ff", "FRAME_SIZE_ERROR", /multiple/i, done);
        });

        it("should fail on non-zero stream id frame", (done) => {
    ...
    describe("WINDOW_UPDATE", () => {
        ...
        it("should parse frame with negative window", (done) => {
        ...
        it("should fail on bigger frame", (done) => {
            fail("000005080000000000009f000102", "FRAME_SIZE_ERROR", /length/i, done);
        });

        it("should fail on smaller frame", (done) => {
    ...
    describe("HEADERS", () => {
        ...
        it("should unpad data", (done) => {
            const hello = "40849cb4507f84f07b2893";

            const first = `000011010c0000000105${hello}ABCDEF1234`;
        ...
        it("should parse headers with continuation", (done) => {
            const hello = "40849cb4507f84f07b2893";
            const how = "40839cfe3f871d8553d1edff3f";

            const first = `00000b010000000001${hello}`;
            const second = `00000d090400000001${how}`;
        ...
        it("should fail on zero stream id", (done) => {
            const first = "000000010000000000";
            fail(first, "PROTOCOL_ERROR", /stream id/i, done);
        });

        it("should fail to unpad too big data", (done) => {
            const hello = "40849cb4507f84f07b2893";

            const first = `000011010c00000001ff${hello}ABCDEF1234`;

            fail(first, "PROTOCOL_ERROR", /invalid padding/i, done);
        });

        it("should fail to unpad too small data", (done) => {
            const first = "000000010c00000001";

            fail(first, "FRAME_SIZE_ERROR", /not enough space/i, done);
        });

        it("should fail on just continuation", (done) => {
            const how = "40839cfe3f871d8553d1edff3f";
        ...
        it("should fail on way double END_HEADERS continuations", (done) => {
            const hello = "40849cb4507f84f07b2893";
            const how = "40839cfe3f871d8553d1edff3f";
        ...
        it("should fail on way too many continuations", (done) => {
            const hello = "40849cb4507f84f07b2893";
            const how = "40839cfe3f871d8553d1edff3f";

            const first = `00000b010000000001${hello}`;
            const second = `00000d090000000001${how}`;

            const msg = first + new Array(200).join(second);
    ...
    describe("RST_STREAM", () => {
        it("should parse general frame", (done) => {
        ...
        it("should fail on 0-stream", (done) => {
            fail("0000040300000000000000000a", "PROTOCOL_ERROR", /stream id/i, done);
        });

        it("should fail on empty frame", (done) => {
    ...
    describe("DATA", () => {
        ...
        it("should parse partial frame", (done) => {
        ...
        it("should parse END_STREAM frame", (done) => {
        ...
        it("should parse partial END_STREAM frame", (done) => {
        ...
        it("should parse padded frame", (done) => {
        ...
        it("should not parse partial padded frame", (done) => {
        ...
        it("should fail on incorrectly padded frame", (done) => {
    ...
    describe("PUSH_PROMISE", () => {
        ...
        it("should fail on incorreclty padded frame", (done) => {
            const hello = "40849cb4507f84f07b2893";
        ...
        it("should fail on 0-stream id", (done) => {
            const hello = "40849cb4507f84f07b2893";
    ...
    describe("PING", () => {
        ...
        it("should fail too big frame", (done) => {
        ...
        it("should fail on non-zero stream id", (done) => {
    ...
    describe("GOAWAY", () => {
        ...
        it("should parse frame with debug data", (done) => {
    ...
    describe("PRIORITY", () => {
        ...
        it("should parse exclusive frame", (done) => {
        ...
        it("should fail on too big frame", (done) => {
