        ...
        describe("interfaces", () => {
            describe("_queryInterfaceByDefinition()", () => {
                ...
                it("should throw for unknown context", () => {
                    assert.throws(() => netron.peer._queryInterfaceByDefinition(100500), adone.error.NotExistsException);
                });
            });
            ...
            describe("weak context and inversion of control", () => {
                ...
                it("call released weak context", async function () {
                    ...
                    await assert.throws(async () => iWeak.doSomething(), adone.error.NotExistsException, /Stub for definition with id/);
                });
