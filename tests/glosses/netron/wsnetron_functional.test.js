...
describe("WebSocket Netron", () => {
    ...
    describe("Functional tests", function () {
        it.skip("Connection: [1] -> [2] -> [3]", async function () {
        ...
        describe("Interfacing", function () {
            ...
            describe("Weak-contexts", function () {
                ...
                describe("cycle weak-context transmission", function () {
            ...
            describe("Exceptions", function () {
                ...
                for (const i of ["local", "remote"]) {
                    it(`${i} - standart exceptions`, async() => {
                        ...
                        const stdErrors = [EvalError, RangeError, ReferenceError, SyntaxError, TypeError, URIError, Error];
