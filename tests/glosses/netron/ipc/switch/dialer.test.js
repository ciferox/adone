...
const Queue = require(adone.getPath("src/glosses/netron/ipc/switch/dialer/queue"));
const QueueManager = require(adone.getPath("src/glosses/netron/ipc/switch/dialer/queueManager"));
const Switch = require(adone.getPath("src/glosses/netron/ipc/switch"));
const { PRIORITY_HIGH, PRIORITY_LOW } = require(adone.getPath("src/glosses/netron/ipc/switch/constants"));
