...
const matchSegments = function (pattern, ifUnix, ifWin, opts) {
    const res = toRegex(pattern, { filepath: true, ...opts });
...
describe("glob", "toRegex", () => {
    it("standard", () => {
        const res = toRegex("*.js");
        assert.equal(typeof toRegex, "function", "consturctor is a typeof function");
