const {
    ...
    p2p: { util: { AbortController, abortableIterator }, transport: { TCP } },
    ...
    describe("close", () => {
        ...
        it("closing one of the muxed streams doesn't close others", async () => {
            ...
            const streamResults = streams.map(async (stream) => {
                ...
                try {
                    const abortableRand = abortableIterator(infiniteRandom, controller.signal, { abortCode: "ERR_TEST_ABORT" });
