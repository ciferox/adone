describe.skip("log", function () { // TODO: it starts connecting and breaks everything else
    const dialect = this.getTestDialect();

    beforeEach(function () {
        this.spy = spy(console, "log");
    });
    ...
    describe("with disabled logging", () => {
        beforeEach(function () {
            this.sequelize = new this.Sequelize("db", "user", "pw", { dialect, logging: false });
        });
    ...
    describe("with default logging options", () => {
        beforeEach(function () {
            this.sequelize = new this.Sequelize("db", "user", "pw", { dialect });
        });
    ...
    describe("with a custom function for logging", () => {
        beforeEach(function () {
            this.spy = spy();
            this.sequelize = new this.Sequelize("db", "user", "pw", { dialect, logging: this.spy });
        });
