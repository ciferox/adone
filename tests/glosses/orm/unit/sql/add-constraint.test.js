...
describe(Support.getTestDialectTeaser("SQL"), { skip: !current.dialect.supports.constraints.addConstraint }, () => {
    describe("addConstraint", () => {
        ...
        describe("validation", () => {
            ...
            it("calls getConstraintSnippet function", () => {
                ...
                const addConstraintQuerySpy = stub(sql, "addConstraintQuery");
