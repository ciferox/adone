    ...
    const suites = {
        ...
        insertQuery: [
            ...
            },
            {
                ...
                arguments: ["myTable", { name: "foo", birthday: adone.datetime("2011-03-27 10:01:55 +0000", "YYYY-MM-DD HH:mm:ss Z").toDate() }],
        ...
        bulkInsertQuery: [
            {
                ...
                arguments: ["myTable", [{ name: "foo", birthday: adone.datetime("2011-03-27 10:01:55 +0000", "YYYY-MM-DD HH:mm:ss Z").toDate() }, { name: "bar", birthday: adone.datetime("2012-03-27 10:01:55 +0000", "YYYY-MM-DD HH:mm:ss Z").toDate() }]],
        ...
        updateQuery: [
            {
                arguments: ["myTable", { name: "foo", birthday: adone.datetime("2011-03-27 10:01:55 +0000", "YYYY-MM-DD HH:mm:ss Z").toDate() }, { id: 2 }],
                ...
                arguments: [{ tableName: "myTable", schema: "mySchema" }, { name: "foo", birthday: adone.datetime("2011-03-27 10:01:55 +0000", "YYYY-MM-DD HH:mm:ss Z").toDate() }, { id: 2 }],
            ...
            // Variants when quoteIdentifiers is false
            {
                ...
                arguments: [{ schema: "mySchema", tableName: "myTable" }, { name: "foo", birthday: adone.datetime("2011-03-27 10:01:55 +0000", "YYYY-MM-DD HH:mm:ss Z").toDate() }, { id: 2 }],
                expectation: "UPDATE mySchema.myTable SET name='foo',birthday='2011-03-27 10:01:55.000 +00:00' WHERE id = 2",
                context: { options: { quoteIdentifiers: false } }
            }, {
