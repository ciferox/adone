...
describe("pin", () => {
    ...
    describe("isPinnedWithType", () => {
        ...
        it("when node is not in datastore", () => {
        ...
        it("when node is in datastore but not pinned", () => {
            return pin.rm(pins.root)
                .then(() => expectPinned(pins.root, false));
        });

        it("when pinned recursively", () => {
    ...
    describe("add", () => {
        ...
        it("recursive pin parent of direct pin", () => {
        ...
        it("directly pinning a recursive pin fails", () => {
            return pin.add(pins.root)
