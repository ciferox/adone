...
module.exports = (repoPath, opts) => {
    ...
    const exec = (args) => execa(adone.getPath("lib/ipfs/main/cli/bin.js"), args, config);
    const execRaw = (args) => execa(adone.getPath("lib/ipfs/main/cli/bin.js"), args, Object.assign({}, config, {
        encoding: null
    }));
