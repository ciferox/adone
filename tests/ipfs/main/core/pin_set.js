...
const createPinSet = require(adone.getPath("lib/ipfs/main/core/components/pin-set"));
...
describe("pinSet", () => {
    ...
    describe("storeItems", () => {
        it("generates a root node with links and hash", (done) => {
    ...
    describe("walkItems", () => {
        it("fails if node doesn't have a pin-set protobuf header", (done) => {
        ...
        it("visits all non-fanout links of a root node", (done) => {
            const seen = [];
