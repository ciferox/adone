...
describe("name-pubsub", () => {
    describe("enabled", () => {
        ...
        describe("pubsub commands", () => {
            it("should get enabled state of pubsub", () => {
        ...
        describe("pubsub records", () => {
            ...
            before(function (done) {
                ...
                ipfsA(`add ${initFilesPath("init-docs/readme")}`)
                    .then((out) => {
    ...
    describe("disabled", () => {
        ...
        it("should get disabled state of pubsub", () => {
            return ipfsA("name pubsub state")
                .then((res) => {
                    expect(res).to.exist();
        ...
        it("should get error getting the available subscriptions", () => {
            return ipfsA("name pubsub subs")
                .catch((err) => {
        ...
        it("should get error canceling a subscription", () => {
