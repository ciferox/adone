...
module.exports = (repoPath, opts) => {
    ...
    const exec = (args) => execa(adone.std.path.join(adone.ROOT_PATH, "lib/ipfs/ipfs/cli/bin.js"), args, config);
    const execRaw = (args) => execa(adone.std.path.join(adone.ROOT_PATH, "lib/ipfs/ipfs/cli/bin.js"), args, Object.assign({}, config, {
        encoding: null
    }));
