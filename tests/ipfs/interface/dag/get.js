const {
    ipfs: { UnixFs, ipld: { dagPb, dagCbor } }
} = adone;
...
module.exports = (createCommon, options) => {
    ...
    describe(".dag.get", () => {
        ...
        it("should get a dag-pb node local value", (done) => {
        ...
        it("should get dag-pb value via dag-cbor node", (done) => {
        ...
        it("should get by CID string + path", (done) => {
            const cidCborStr = cidCbor.toBaseEncodedString();
        ...
        it("should get only a CID, due to resolving locally only", (done) => {
