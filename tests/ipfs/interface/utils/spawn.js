...
const identify = function(node, cb) {
    node.id((err, id) => {
        if (err) {
            return cb(err); 
        }
...
const spawnNodeWithId = function(factory, callback) {
...
// Spawn n nodes
const spawnNodes =function(n, factory, callback) {
...
const spawnNodesWithId = function(n, factory, callback) {
