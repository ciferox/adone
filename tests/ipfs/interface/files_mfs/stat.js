...
const { fixtures } = require("../files_regular/utils");
...
module.exports = (createCommon, options) => {
    ...
    describe(".files.stat", function () {
        ...
        it("should not stat not found file/dir, expect error", (done) => {
        ...
        it.skip("should stat withLocal file", (done) => {
        ...
        // TODO enable this test when this feature gets released on go-ipfs
        it.skip("should stat withLocal dir", (done) => {
        ...
        it("should stat outside of mfs", (done) => {
