...
export function getAssetFileName(asset, existingNames, assetFileNames) {
...
export function createAssetPluginHooks(assetsById, outputBundle, assetFileNames) {
    return {
...
export function finaliseAsset(asset, outputBundle, assetFileNames) {
