...
export default function umd(magicString, { graph, namedExportsMode, hasExports, indentString: t, intro, outro, dependencies, exports }, options) {
    ...
    const defaultExport = !namedExportsMode && hasExports
