...
export default function system(magicString, { graph, indentString: t, intro, outro, dependencies, exports }, options) {
    ...
    let wrapperStart = `System.register(${registeredName}[${dependencyIds.join(`,${_}`)}],${_}function${_}(exports,${_}module)${_}{${n}`;
