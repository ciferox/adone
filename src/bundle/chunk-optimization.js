 ...
 *
 */
export function optimizeChunks(chunks, options, CHUNK_GROUPING_SIZE, inputBase) {
    for (let chunkIndex = 0; chunkIndex < chunks.length; chunkIndex++) {
        ...
        do {
            ...
            if (lastChunk.postVisitChunkDependencies(dep => {
            ...
            if (chunk.postVisitChunkDependencies(dep => {
