...
namespace transport {
    ...
    inline void Register(v8::Local<v8::Function> constructor) {
        ...
        (void)napa::module::binding::Call("../transport/transport", "register", sizeof(argv) / sizeof(v8::Local<v8::Value>), argv);
    }
    ...
    inline v8::MaybeLocal<v8::Value> Unmarshall(v8::Local<v8::Value> payload, v8::Local<v8::Object> transportContextWrap) {
        ...
        return napa::module::binding::Call("../transport/transport", "unmarshall", sizeof(argv) / sizeof(v8::Local<v8::Value>), argv);
    }
