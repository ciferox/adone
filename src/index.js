...
lazify({
    ...
    inspect: ["./glosses/text/inspect", (mod) => mod.inspect],
    inspectError: ["./glosses/text/inspect", (mod) => mod.inspectError],
...
adone.netron = lazify({
    ...
    Netron: "./glosses/netron/species/native/netron",
    Peer: "./glosses/netron/species/native/peer",
...
adone.netron.ws = lazify({
    Adapter: "./glosses/netron/species/ws/adapter",
    Netron: "./glosses/netron/species/ws/netron",
    Peer: "./glosses/netron/species/ws/peer"
});
