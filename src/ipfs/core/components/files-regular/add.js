...
module.exports = function (self) {
    const add = promisify((data, options, callback) => {
        ...
        const isBufferOrStream = (obj) => is.buffer(obj) || isStream.readable(obj) || isSource(obj);
        ...
        const isContentObject = (obj) => {
            ...
            if (obj.content) {
                return isBufferOrStream(obj.content);
            }
        ...
        const ok = isInput(data) || (is.array(data) && data.every(isInput));
