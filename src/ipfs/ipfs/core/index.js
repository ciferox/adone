...
const {
    ipfs: { isIPFS, ipld: { Ipld }, BlockService, libp2p: { crypto, PeerId, PeerInfo, PeerBook } }
} = adone;
...
const IpldFormats = {
    ...
    get 'eth-account-snapshot'() {
        return adone.ipfs.ipld.ethereum.ethAccountSnapshot
    },
    get 'eth-block'() {
        return adone.ipfs.ipld.ethereum.ethBlock
    },
    get 'eth-block-list'() {
        return adone.ipfs.ipld.ethereum.ethBlockList
    },
    get 'eth-state-trie'() {
        return adone.ipfs.ipld.ethereum.ethStateTrie
    },
    get 'eth-storage-trie'() {
        return adone.ipfs.ipld.ethereum.ethStorageTrie
    },
    get 'eth-tx'() {
        return adone.ipfs.ipld.ethereum.ethTx
    },
    get 'eth-tx-trie'() {
        return adone.ipfs.ipld.ethereum.ethTxTrie
    },
    get 'git-raw'() {
