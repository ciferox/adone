 ...
 */
module.exports = (...args) => {
    const options = is.string(args[args.length - 1]) ? {} : args.pop();
    const paths = args;
    ...
    const globSourceOptions = {
        ...
        glob: {
            ...
            ignore: is.array(options.ignore) ? options.ignore : [],
            follow: !is.nil(options.followSymlinks) ? options.followSymlinks : true
        }
    };
