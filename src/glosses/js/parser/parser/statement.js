...
export default class StatementParser extends ExpressionParser {
    ...
    parseForIn(
      ...
      !is.nil(init.declarations[0].init) &&
      (!isForIn ||
        this.state.strict ||
        init.kind !== "var" ||
    ...
    parseFunction<T: N.NormalFunction>(
        ...
        const requireId = Boolean(isStatement) && !(statement & FUNC_NULLABLE_ID);
    ...
    parseClass<T: N.Class>(
        ...
        node.body = this.parseClassBody(Boolean(node.superClass));
    ...
    parseExport(node: N.Node): N.AnyExport {
      ...
      (hasNamespace && parseAfterNamespace && !hasSpecifiers)
        ...
        if (isFromRequired || hasSpecifiers || hasDeclaration) {
            this.checkExport(node, true, false, Boolean(node.source));
