const {
    js: { compiler: { types: t, traverse, helper: { optimiseCallExpression, memberExpressionToFunctions } } }
} = adone;
...
const specHandlers = {
    ...
    call(superMember, args) {
        return optimiseCallExpression(this.get(superMember), t.thisExpression(), args);
    }
};
...
ReplaceSupers.environmentVisitor = environmentVisitor;
