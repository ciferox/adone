...
const plugins = {
    ...
    syntax: lazify({
        ...
        doExpressions: "./syntax/do_expressions",
        flow: "./syntax/flow",
        exportDefaultFrom: "./syntax/export_default_from",
        // functionBind: "./syntax/function_bind",
        // objectRestSpread: "./syntax/object_rest_spread",
        // // jsx: "./syntax/jsx"
        numericSeparator: "./syntax/numeric_separator",
        partialApplication: "./syntax/partial_application",
    ...
    transform: lazify({
        ...
        doExpressions: "./transform/do_expressions",
        decorators: "./transform/decorators",
        modulesCommonjs: "./transform/modules_commonjs",
        exportDefaultFrom: "./transform/export_default_from",
        flowStripTypes: "./transform/flow_strip_types",
        partialApplication: "./transform/partial_application",
