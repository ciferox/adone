...
export default class StatementParser extends ExpressionParser {
    ...
    parseStatementContent(declaration: boolean, topLevel: ?boolean): N.Statement {
        ...
        switch (starttype) {
            ...
            case tt._export:
            case tt._import:
                if ((this.hasPlugin("dynamicImport") && this.lookahead().type === tt.parenL) || (this.hasPlugin("importMeta") && this.lookahead().type === tt.dot)) {
                    break;
                }
    ...
    parseLabeledStatement(
        ...
        if (node.body.type === "ClassDeclaration" ||
            ...
            (node.body.type === "FunctionDeclaration" && (this.state.strict || node.body.generator || node.body.async))
        ) {
