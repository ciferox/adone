...
export default class LValParser extends NodeUtils {
    ...
    //   +parseIdentifier: (liberal) => Identifier;
            ...
            default: {
                const message =
                    `${isBinding
                        ...
                        : "Invalid"
                    } left-hand side${contextDescription ? ` in ${contextDescription}` : /* istanbul ignore next */ "expression"}`;
    ...
    checkToRestConversion(node) {
        ...
        if (validArgumentTypes.includes(node.argument.type)) {
            return;
        }
