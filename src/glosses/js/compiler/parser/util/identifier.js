...
const makePredicate = function (words) {
    const wordsArr = words.split(" ");
    return function (str) {
        return wordsArr.includes(str);
    };
};
...
// rare.
const isInAstralSet = function (code, set) {
    let pos = 0x10000;
...
export const isIdentifierStart = function (code) {
...
export const isIteratorStart = function (current, next) {
    return current === charCodes.atSign && next === charCodes.atSign;
};

// Test whether a given character is part of an identifier.

export const isIdentifierChar = function (code) {
