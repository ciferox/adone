...
export default class OptionManager {
    ...
    resolvedConfigs: string[];
    options: Object;
    log: ?Logger;

    static memoisedPlugins: Array<{
        container: Function;
        plugin: adone.js.compiler.transformation.Plugin;
    }>;
    ...
    static memoisePluginContainer(fn, loc, i, alias) {
        ...
        if (typeof obj === "object") {
            const plugin = new adone.js.compiler.transformation.Plugin(obj, alias);
    ...
    static normalisePlugin(plugin, loc, i, alias) {
        ...
        if (!(plugin instanceof adone.js.compiler.transformation.Plugin)) {
