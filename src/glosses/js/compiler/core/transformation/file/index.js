...
export default class File extends Store {
    ...
    buildPluginsForOptions(opts) {
        ...
        const plugins: [PluginPass, Object][] = opts.plugins.concat(INTERNAL_PLUGINS);
    ...
    call(key: "pre" | "post", pluginPasses: PluginPass[]) {
