...
export const createItemFromDescriptor = (desc) => new ConfigItem(desc);
 ...
 */
export const createConfigItem = function (value, { dirname = ".", type } = {}) {
...
export const getItemDescriptor = function (item) {
