...
export function assertCompact(
    ...
    if (!is.undefined(value) && !is.boolean(value) && value !== "auto") {
...
export function assertObject(loc: GeneralPath, value: mixed): {} | void {
    if (
        !is.undefined(value) &&
    (typeof value !== "object" || is.array(value) || !value)
    ) {
...
export function assertArray(
    ...
    if (!is.nil(value) && !is.array(value)) {
    ...
    if (is.array(value)) {
        ...
        if (value.length > 1) {
            ...
            if (
                !is.undefined(opts) &&
        opts !== false &&
        (typeof opts !== "object" || is.array(opts))
            ) {
                throw new Error(
        ...
        if (value.length === 3) {
            const name = value[2];
            if (!is.undefined(name) && !is.string(name)) {
                throw new Error(
