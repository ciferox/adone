...
class SelectPrompt extends ArrayPrompt {
    ...
    separator() {
        ...
        const sep = this.styles.muted(this.symbols.ellipsis);
    ...
    async renderChoice(choice, i) {
        ...
        const line = () => [this.margin[3], ind + pointer + check, msg, this.margin[1], hint].filter(Boolean).join(" ");
    ...
    async render() {
        ...
        if (submitted && !output && !body.trim() && this.multiple && !is.nil(this.emptyError)) {
