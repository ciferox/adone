...
class Editable extends Select {
    constructor(options) {
        ...
        this.align = [this.options.align, "left"].find((v) => !is.nil(v));
        this.emptyError = "";
        this.values = {};
    }
    ...
    async indicator(choice, i) {
        const symbol = choice.indicator || "";
        const value = choice.editable ? symbol : super.indicator(choice, i);
    ...
    submit() {
        ...
        for (const choice of this.choices) {
            const val = choice.parent ? this.value[choice.parent.name] : this.value;
