...
keypress.listen = (options = {}, onKeypress) => {
    ...
    const rl = readline.createInterface({ terminal: true, input: stdin });
    readline.emitKeypressEvents(stdin, rl);

    const on = (buf, key) => onKeypress(buf, keypress(buf, key), rl);
...
keypress.action = (buf, key, customActions) => {
    const obj = { ...combos, ...customActions };
    if (key.ctrl) {
