...
const {
    is,
    cli: { esc: ansiStyles, stats: { stdout: stdoutColor } }
} = adone;
...
const template = (chalk, temporary) => {
    const styles = [];
    const chunks = [];
    let chunk = [];
...
const applyOptions = (object, options = {}) => {
    ...
    object.level = is.undefined(options.level) ? colorLevel : options.level;
