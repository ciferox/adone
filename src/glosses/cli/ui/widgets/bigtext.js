...
export default class BigText extends adone.cli.ui.widget.Element {
    constructor(options = {}) {
        options.font = options.font || path.join(adone.realm.rootRealm.env.SHARE_PATH, "terminal/fonts/ter-u14n.json");
        options.fontBold = options.font || path.join(adone.realm.rootRealm.env.SHARE_PATH, "terminal/fonts/ter-u14b.json");
        super(options);
