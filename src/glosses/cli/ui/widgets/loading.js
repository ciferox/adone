...
export default class Loading extends adone.cli.ui.widget.Element {
    constructor(options = { }) {
    ...
    start() {
        ...
        const renderContent = () => {
            ...
            this.setContent(`${adone.cli.generateTags(this.options.style.spinner, frames[this._.frame++ % frames.length])} ${this._.message}`);
            this.screen.render();
        };
