...
export default class Prompt extends adone.cli.ui.widget.Element {
    constructor(options = { }) {
        options.hidden = true;
        super(options);

        this._.input = new adone.cli.ui.widget.TextBox({
            parent: this,
            top: 3,
            height: 1,
            left: 2,
        ...
        this._.okay = new adone.cli.ui.widget.Button({
            parent: this,
            top: 5,
            height: 1,
            left: 2,
        ...
        this._.cancel = new adone.cli.ui.widget.Button({
            parent: this,
            top: 5,
            height: 1,
            shrink: true,
