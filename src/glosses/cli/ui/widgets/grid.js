...
class DefaultWidget extends adone.cli.ui.widget.Element {
    constructor(options) {
        super(options);
    }
}

export default class Grid extends adone.cli.ui.widget.Element {
    constructor(options = { }) {
    ...
    _calculatePos(content, dockId, left, top, cols, rows) {
        ...
        if (content.rows) {
            ...
            throw new adone.error.NotValidException("nothing 'cols' or 'rows' specified");
        }
