...
function Terminal(options) {
    if (!(this instanceof adone.cli.ui.widget.Node)) {
    ...
    adone.cli.ui.widget.Element.call(this, options);
...
Terminal.prototype.__proto__ = adone.cli.ui.widget.Element.prototype;
