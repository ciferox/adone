...
const mapData = adone.lazify({
    world: std.path.join(adone.realm.rootRealm.env.SHARE_PATH, "term/maps/world.json"),
    antartica: std.path.join(adone.realm.rootRealm.env.SHARE_PATH, "term/maps/antartica.json"),
    us: std.path.join(adone.realm.rootRealm.env.SHARE_PATH, "term/maps/us.json")
}, null, require);
