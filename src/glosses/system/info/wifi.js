...
function wifiNetworks(callback) {
    ...
    return new Promise((resolve) => {
        process.nextTick(() => {
            const result = [];
            if (_linux) {
                const cmd = "nmcli --terse --fields active,ssid,bssid,mode,chan,freq,signal,security,wpa-flags,rsn-flags device wifi list";
                ...
                const cmd = "/System/Library/PrivateFrameworks/Apple80211.framework/Versions/Current/Resources/airport -s";
                exec(cmd, { maxBuffer: 1024 * 20000 }, (error, stdout) => {
                ...
                const cmd = "chcp 65001 && netsh wlan show networks mode=Bssid";
