...
export default class {
    ...
    _analyze(key, text, entity, index) {
        const options = this.options;
        let words;
        let exists = false;
        let existingResult;
    ...
    _format() {
        ...
        const replaceValue = options.id ? function (index) {
            results[index].item = getFn(results[index].item, options.id, [])[0];
        } : function () { };

        const getItemAtIndex = function (index) {
