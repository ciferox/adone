...
export default class Logger extends Transform {
    ...
    configure({
        ...
        this.silent = silent;
        this.format = format || this.format || adone.logging.logger.format.json();

        this.defaultMeta = defaultMeta || null;
        // Hoist other options onto this instance.
        this.config = config || adone.logging.logger.config.adone;
        this.levels = {};
    ...
    _transform(info, enc, callback) {
        ...
        if (!this._readableState.pipes) {
            ...
            console.error("[adone.logging.logger] Attempt to write logs with no transports %j", info);
        }
