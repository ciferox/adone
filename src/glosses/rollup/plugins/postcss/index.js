...
export default (options = {}) => {
    ...
    const postcssPlugins = is.array(options.plugins) ?
    ...
    const postcssLoaderOptions = {
        ...
        /** Extract CSS */
        extract: is.undefined(options.extract) ? false : options.extract,
        /** CSS modules */
    ...
    return {
        ...
        async transform(code, id) {
            ...
            if (is.function(options.onImport)) {
                options.onImport(id);
            }
        ...
        async generateBundle(opts, bundle) {
            ...
            const getExtracted = () => {
                const fileName =
                    is.string(postcssLoaderOptions.extract) ?
