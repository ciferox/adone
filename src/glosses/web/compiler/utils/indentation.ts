...
export function remove_indentation(code: adone.text.MagicString, node: Node) {
...
export function add_indentation(code: adone.text.MagicString, node: Node, levels = 1) {
