...

    {
        ...
        plugins: [
            plugin.typescript({
                ...
                declaration: true,
                declarationDir: "lib/glosses/web/runtime/foundation/types",
                ...
                dir === "internal" && {
                    writeBundle(bundle) {
                        if (dir === "internal") {
                            ...
                            if (mod) {
                                fs.writeFileSync("src/glosses/web/compiler/compile/internal_exports.ts", `// This file is automatically generated\nexport default new Set(${JSON.stringify(mod.exports)});`);
                            }
                        }

                        fs.writeFileSync(`lib/glosses/web/runtime/foundation/${dir}/package.json`, JSON.stringify({
                            main: "./index",
                            module: "./index.mjs",
                            types: "./index.d.ts"
                        }, null, "  "));

                        fs.writeFileSync(`lib/glosses/web/runtime/foundation/${dir}/index.d.ts`, `export * from '../types/runtime/${dir}/index';`);
                    }
                }
            ]
        }))
