...
export class Point extends Primitive {
    constructor(...args) {
        ...
        if (input && input.type === "Point" && input.coordinates) {
            ...
            throw new exception.InvalidArgument("Terraformer: invalid input for Terraformer.Point");
        }
...
export class MultiPoint extends Primitive {
    constructor(input) {
        ...
        if (input && input.type === "MultiPoint" && input.coordinates) {
            ...
            throw new exception.InvalidArgument("Terraformer: invalid input for Terraformer.MultiPoint");
        }
...
export class LineString extends Primitive {
    constructor(input) {
        ...
        if (input && input.type === "LineString" && input.coordinates) {
            ...
            throw new exception.InvalidArgument("Terraformer: invalid input for Terraformer.LineString");
        }
...
export class MultiLineString extends Primitive {
    constructor(input) {
        ...
        if (input && input.type === "MultiLineString" && input.coordinates) {
            ...
            throw new exception.InvalidArgument("Terraformer: invalid input for Terraformer.MultiLineString");
        }
...
export class Polygon extends Primitive {
    constructor(input) {
        ...
        if (input && input.type === "Polygon" && input.coordinates) {
            ...
            throw new exception.InvalidArgument("Terraformer: invalid input for Terraformer.Polygon");
        }
...
export class MultiPolygon extends Primitive {
    constructor(input) {
        ...
        if (input && input.type === "MultiPolygon" && input.coordinates) {
            ...
            throw new exception.InvalidArgument("Terraformer: invalid input for Terraformer.MultiPolygon");
        }
...
export class Feature extends Primitive {
    constructor(input) {
        ...
        if (input && input.type === "Feature") {
            ...
            throw new exception.InvalidArgument("Terraformer: invalid input for Terraformer.Feature");
        }
        this.type = "Feature";
    }
}
...
export class FeatureCollection extends Primitive {
    constructor(input) {
        ...
        if (input && input.type === "FeatureCollection" && input.features) {
            ...
            throw new exception.InvalidArgument("Terraformer: invalid input for Terraformer.FeatureCollection");
        }
...
export class GeometryCollection extends Primitive {
    constructor(input) {
        ...
        if (input && input.type === "GeometryCollection" && input.geometries) {
            ...
            throw new exception.InvalidArgument("Terraformer: invalid input for Terraformer.GeometryCollection");
        }
