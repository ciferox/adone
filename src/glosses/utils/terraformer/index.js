...
Primitive.prototype.convexHull = function () {
    ...
    if (this.type === "Point") {
        ...
        const primitive = new Primitive(this.geometry);
...
Primitive.prototype.within = function (primitive) {
    ...
    if (primitive.type === "Polygon") {
        ...
        if (this.type === "Polygon") {
            ...
            for (i = 0; i < this.coordinates.length; i++) {
                const p1 = new Primitive({ type: "Polygon", coordinates: this.coordinates[i] });
...
Primitive.prototype.intersects = function (primitive) {
    ...
    const p = new Primitive(primitive);
    ...
    if (this.type !== "Point" && this.type !== "MultiPoint" &&
        ...
        const inner = new Primitive(this.geometry);
