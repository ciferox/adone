...
const MultiPoint = require("./multi_point");
const MultiLineString = require("./multi_line_string");
const MultiPolygon = require("./multi_polygon");
const GeometryCollection = require("./geometry_collection");
const BinaryReader = require("./binary_reader");
const BinaryWriter = require("./binary_writer");
const WktParser = require("./wkt_parser");
const ZigZag = require("./zig_zag.js");
...
Geometry.parse = function (value, options) {
    ...
    } else if (is.buffer(value) || value instanceof BinaryReader) {
