 ...
 */
const FindOperatorsUnordered = function (self) {
    this.s = self.s;
};
...
//
const addToOperationsList = function (_self, docType, document) {
    // Get the bsonSize
...
const UnorderedBulkOperation = function (topology, collection, options) {
    ...
    const writeConcern = common.writeConcern(shallowClone(options), collection, options);
...
const define = UnorderedBulkOperation.define = new Define("UnorderedBulkOperation", UnorderedBulkOperation, false);
...
//
// Execute the command
const executeBatch = function (self, batch, callback) {
    const finalOptions = { ordered: false };
    if (self.s.writeConcern != null) {
        finalOptions.writeConcern = self.s.writeConcern;
    }

    const resultHandler = function (err, result) {
...
const executeBatches = function (self, callback) {
 ...
 * @ignore
 */
const initializeUnorderedBulkOp = function (topology, collection, options) {
