 ...
 */
const FindOperatorsOrdered = function (self) {
    this.s = self.s;
};
...
const define = OrderedBulkOperation.define = new Define("OrderedBulkOperation", OrderedBulkOperation, false);
 ...
 * @ignore
 */
const initializeOrderedBulkOp = function (topology, collection, options) {
