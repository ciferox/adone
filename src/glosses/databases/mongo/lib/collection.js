...
const bulkWrite = function (self, operations, options, callback) {
    // Add ignoreUndfined
    ...
    const bulk = options.ordered == true || options.ordered == null ? self.initializeOrderedBulkOp(options) : self.initializeUnorderedBulkOp(options);
...
const updateOne = function (self, filter, update, options, callback) {
...
const replaceOne = function (self, filter, doc, options, callback) {
    // Set single document update
    options.multi = false;
...
const updateMany = function (self, filter, update, options, callback) {
    // Set single document update
    options.multi = true;
    // Execute update
    updateDocuments(self, filter, update, options, (err, r) => {
...
const save = function (self, doc, options, callback) {
    // Get the write concern options
    const finalOptions = writeConcern(shallowClone(options), self.s.db, self, options);
...
const rename = function (self, newName, opt, callback) {
...
const createIndex = function (self, fieldOrSpec, options, callback) {
...
const createIndexes = function (self, indexSpecs, callback) {
    const capabilities = self.s.topology.capabilities();
...
const ensureIndex = function (self, fieldOrSpec, options, callback) {
...
const indexInformation = function (self, options, callback) {
...
const distinct = function (self, key, query, options, callback) {
    // maxTimeMS option
    const maxTimeMS = options.maxTimeMS;
...
const indexes = function (self, callback) {
...
const stats = function (self, options, callback) {
...
const findAndModify = function (self, query, sort, doc, options, callback) {
    ...
    const finalOptions = writeConcern(options, self.s.db, self, options);
...
const geoNear = function (self, x, y, point, options, callback) {
    // Build command object
    let commandObject = {
        geoNear: self.s.name,
        near: point || [x, y]
...
const geoHaystackSearch = function (self, x, y, options, callback) {
    // Build command object
    let commandObject = {
...
const group = function (self, keys, condition, initial, reduce, finalize, command, options, callback) {
    ...
    if (command) {
        ...
        const scope = reduce != null && reduce._bsontype == "Code"
            ? reduce.scope
            : {};
