...
Object.defineProperty(Pool.prototype, "socketTimeout", {
    enumerable: true,
    get() { return this.options.socketTimeout; }
});
...
Pool.prototype.logout = function (dbName, callback) {
    ...
    const connections = self.availableConnections.concat(self.inUseConnections);
...
Pool.prototype.write = function (commands, options, cb) {
    ...
    if (this.options.domainsEnabled
        ...
        cb = process.domain.bind(function () {
            ...
            const args = new Array(arguments.length); for (let i = 0; i < arguments.length; i++) { args[i] = arguments[i]; }
    ...
    const operation = {
        cb, raw: false, promoteLongs: true, promoteValues: true, promoteBuffers: false, fullResult: false
    };
...
function _createConnection(self) {
    ...
    // Handle any errors
    const tempErrorHandler = function (_connection) {
        return function () {
            // Destroy the connection
            _connection.destroy();
    ...
    const tempConnectHandler = function (_connection) {
        return function () {
