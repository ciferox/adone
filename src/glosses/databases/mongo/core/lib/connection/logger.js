 ...
 */
const Logger = function (className, options) {
...
Logger.prototype.debug = function (message, object) {
    if (this.isDebug()
        ...
        const state = {
            type: "debug", message, className: this.className, pid, date: dateTime
        };
...
Logger.prototype.warn = function (message, object) {
    if (this.isWarn()
        ...
        const state = {
            type: "warn", message, className: this.className, pid, date: dateTime
        };
        if (object) state.meta = object;
        currentLogger(msg, state);
    }
    ...
    Logger.prototype.info = function (message, object) {
        if (this.isInfo()
            ...
            const state = {
                type: "info", message, className: this.className, pid, date: dateTime
            };
            if (object) state.meta = object;
            currentLogger(msg, state);
        }
    ...
    Logger.prototype.error = function (message, object) {
        if (this.isError()
            ...
            const state = {
                type: "error", message, className: this.className, pid, date: dateTime
            };
            if (object) state.meta = object;
            currentLogger(msg, state);
        }
