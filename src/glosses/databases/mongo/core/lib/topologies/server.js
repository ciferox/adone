...
const PreTwoSixWireProtocolSupport = require("../wireprotocol/2_4_support");
...
const eventHandler = function (self, event) {
    return function (err) {
        // Log information of received information if in info mode
        if (self.s.logger.isInfo()) {
            const object = err instanceof MongoError ? JSON.stringify(err) : {};
