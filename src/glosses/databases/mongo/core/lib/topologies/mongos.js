 ...
 */
const Mongos = function (seedlist, options) {
    options = options || {};
            ...
            applyAuthenticationContexts(self, _this, function () {
                ...
                if (self.ismaster.msg == "isdbgrid") {
                    ...
                    if (self.s.logger.isWarn()) {
                        let message = "expected mongos proxy, but found replicaset member mongod for server %s";
...
function pickProxy(self) {
    ...
    for (let i = 0; i < connectedProxies.length; i++) {
...
Mongos.prototype.connections = function () {
    ...
    for (let i = 0; i < this.connectedProxies.length; i++) {
