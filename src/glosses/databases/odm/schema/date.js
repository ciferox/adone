 ...
 * @api public
 */
export default class SchemaDate extends SchemaType {
        ...
        if (value) {
            ...
            this.validators.push({
                validator: this.minValidator = function (val) {
                    ...
                    return is.null(val) || val.valueOf() >= min.valueOf();
                },
                message: msg,
                type: "min",
                min: value
        ...
        if (value) {
            ...
            this.validators.push({
                validator: this.maxValidator = function (val) {
                    ...
                    return is.null(val) || val.valueOf() <= max.valueOf();
                },
                message: msg,
                type: "max",
                max: value
    ...
    cast(value) {
        ...
        if (is.null(value) || value === void 0 || value === "") {
            return null;
        }
        ...
        if (value instanceof Number || is.number(value)
