...
NextWorker::NextWorker(
    Iterator *iterator, Nan::Callback *callback, void (*localCallback)(Iterator *)) : AsyncWorker(NULL, callback), iterator(iterator), localCallback(localCallback){};
...
EndWorker::EndWorker(
    Iterator *iterator, Nan::Callback *callback) : AsyncWorker(NULL, callback), iterator(iterator){};
