...
const _tempDir = require("./tempdir");
const _pwd = require("./pwd");
...
function execSync(cmd, opts, pipe) {
    ...
    const paramsFile = path.resolve(`${tempDir}/${common.randomFileName()}`);
...
function _exec(command, options, callback) {
    ...
    if (typeof options === "object" && is.function(callback)) {
        options.async = true;
    }
