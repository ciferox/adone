...
import { isFunction, isNumber, isString } from "../../../common";
...
const getOptions = (options, defaultOptions) => {
    ...
    if (isString(options)) {
        ...
        throw new InvalidArgumentException("Invalid options object, must be string or object");
    }
...
export class WriteStream extends Writable {
    constructor(engine, path, options) {
        ...
        this.start = options.start;
        this.autoClose = options.autoClose === undefined ? true : Boolean(options.autoClose);
        this.pos = undefined;
        this.bytesWritten = 0;
