...
const QueryGenerator = {
    ...
    createSchema(schema) {
        ...
        if (databaseVersion && adone.semver.gte(databaseVersion, "9.2.0")) {
    ...
    createTableQuery(tableName, attributes, options) {
        ...
        return `CREATE TABLE ${databaseVersion === 0 || adone.semver.gte(databaseVersion, "9.1.0") ? "IF NOT EXISTS " : ""}${values.table} (${values.attributes})${values.comments};`;
    },
    ...
    pgEnumAdd(tableName, attr, value, options) {
        ...
        if (adone.semver.gte(this.sequelize.options.databaseVersion, "9.3.0")) {
            sql += "IF NOT EXISTS ";
        }
    ...
    setAutocommitQuery(value, options) {
        ...
        if (!value || adone.semver.gte(this.sequelize.options.databaseVersion, "9.4.0")) {
            return;
        }
