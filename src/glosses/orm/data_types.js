...
class STRING extends ABSTRACT {
    ...
    validate(value) {
        if (Object.prototype.toString.call(value) !== "[object String]") {
            ...
            throw new error.ValidationError(sprintf("%j is not a valid string", value));
        }
...
class NUMBER extends ABSTRACT {
    ...
    validate(value) {
        if (!validator.isFloat(String(value))) {
            throw new error.ValidationError(sprintf(`%j is not a valid ${_.toLower(this.key)}`, value));
        }
...
class FLOAT extends NUMBER {
    ...
    validate(value) {
        if (!validator.isFloat(String(value))) {
            throw new error.ValidationError(sprintf("%j is not a valid float", value));
        }
...
class DECIMAL extends NUMBER {
    ...
    validate(value) {
        if (!validator.isDecimal(String(value))) {
            throw new error.ValidationError(sprintf("%j is not a valid decimal", value));
        }
...
class BOOLEAN extends ABSTRACT {
    ...
    validate(value) {
        if (!validator.isBoolean(String(value))) {
            throw new error.ValidationError(sprintf("%j is not a valid boolean", value));
        }
...
class DATE extends ABSTRACT {
    ...
    validate(value) {
        if (!validator.isDate(String(value))) {
            throw new error.ValidationError(sprintf("%j is not a valid date", value));
        }
...
class HSTORE extends ABSTRACT {
    validate(value) {
        if (!_.isPlainObject(value)) {
            throw new error.ValidationError(sprintf("%j is not a valid hstore", value));
        }
...
class BLOB extends ABSTRACT {
    ...
    validate(value) {
        if (!_.isString(value) && !is.buffer(value)) {
            throw new error.ValidationError(sprintf("%j is not a valid blob", value));
        }
...
class RANGE extends ABSTRACT {
    ...
    validate(value) {
        ...
        if (!_.isArray(value)) {
            throw new error.ValidationError(sprintf("%j is not a valid range", value));
        }

        if (value.length !== 2) {
            throw new error.ValidationError("A range must be an array with two elements");
        }
...
class UUID extends ABSTRACT {
    validate(value, options) {
        if (!_.isString(value) || !validator.isUUID(value) && (!options || !options.acceptStrings)) {
            throw new error.ValidationError(sprintf("%j is not a valid uuid", value));
        }
...
class UUIDV4 extends ABSTRACT {
    validate(value, options) {
        if (!_.isString(value) || !validator.isUUID(value, 4) && (!options || !options.acceptStrings)) {
            throw new error.ValidationError(sprintf("%j is not a valid uuidv4", value));
        }
...
class ENUM extends ABSTRACT {
    ...
    validate(value) {
        if (!_.includes(this.values, value)) {
            throw new error.ValidationError(sprintf("%j is not a valid choice in %j", value, this.values));
        }
...
class ARRAY extends ABSTRACT {
    ...
    validate(value) {
        if (!_.isArray(value)) {
            throw new error.ValidationError(sprintf("%j is not a valid array", value));
        }
