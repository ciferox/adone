...
const InstanceValidator = require("./instance_validator");
...
class Model {
    ...
    static findOne(options) {
        ...
        if (is.undefined(options.limit)) {
            ...
            if (!options.where || !(Utils.isPrimitive(pkVal) || is.buffer(pkVal))) {
                options.limit = 1;
            }
        }
    ...
    set(key, value, options) { // testhint options:none
        ...
        if (typeof key === "object" && !is.null(key)) {
            ...
            if (!options.raw && this._customSetters[key]) {
                ...
                if (!Utils.isPrimitive(newValue) && !is.null(newValue) || newValue !== originalValue) {
