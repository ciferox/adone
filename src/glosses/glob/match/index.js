...
const isEmptyString = (val) => is.string(val) && (val === "" || val === "./");
...
const { braces } = adone.lazifyp({
    braces: "./braces"
}, micromatch, require);

const { picomatch } = adone.lazify({
    fillRange: "./fill_range",
    picomatch: "./picomatch",
    toRegexRange: "./to_regex_range"
}, micromatch, require);
const { utils } = picomatch;
...
// micromatch.multimatch = (list, patterns, options = {}) => {
//     list = arrify(list);
