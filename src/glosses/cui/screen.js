...
export default class Screen extends adone.cui.Node {
    constructor(options = {}) {
        super(options);
    ...
    postEnter() {
        ...
        if (this.options.debug) {
            this.debugLog = new adone.cui.widget.Log({
                screen: this,
                parent: this,
                hidden: true,
                draggable: true,
        ...
        if (this.options.warnings) {
            this.on("warning", (text) => {
                const warning = new adone.cui.widget.Element({
                    screen: self,
                    parent: self,
                    left: "center",
                    top: "center",
    ...
    _initHover() {
        ...
        this._hoverText = new adone.cui.widget.Element({
            screen: this,
            left: 0,
            top: 0,
            tags: false,
    ...
    _cursorAttr(cursor, dattr) {
        ...
        if (cursor.shape === "line") {
            ...
            cattr = adone.cui.widget.Element.prototype.sattr.call(cursor, cursor.shape);
