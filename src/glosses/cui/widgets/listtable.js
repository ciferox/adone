...
export default class ListTable extends adone.cui.widget.List {
    constructor(options = { }) {
        // options.shrink = true;
        ...
        this._header = new adone.cui.widget.Element({
            parent: this,
...
ListTable.prototype._calculateMaxes = adone.cui.widget.Table.prototype._calculateMaxes;
