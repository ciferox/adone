...
function hasGlobalProcessEventEmitter() {
    return ((typeof process === "object") && (!is.null(process)) && (is.function(process.on)));
}
...
export function mapSourcePosition(position) {
    ...
    if (sourceMap && sourceMap.map && is.function(sourceMap.map.originalPositionFor)) {
...
export const install = function (options) {
    options = options || {};
