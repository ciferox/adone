...
export default function createInstance(ErrorConstructor = Error) {
    ...
    function mapEvalOrigin(origin) {
        ...
        if (match) {
            const position = object.mapSourcePosition({
                source: match[2],
                line: match[3],
                column: match[4] - 1
            });
    ...
    function wrapCallSite(frame) {
        ...
        if (source) {
            ...
            // console.log(frame.getFileName(), frame.getLineNumber(), frame.getColumnNumber());
            const position = object.mapSourcePosition({ source, line, column });
