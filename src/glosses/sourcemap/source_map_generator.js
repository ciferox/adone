...
const { MappingList } = require("./mapping_list");
...
export default class SourceMapGenerator {
    ...
    addMapping(aArgs) {
        ...
        this._mappings.add({
            ...
            originalLine: !is.nil(original) && original.line,
            originalColumn: !is.nil(original) && original.column,
            source,
            name
        });
    }
    ...
    applySourceMap(aSourceMapConsumer, aSourceFile, aSourceMapPath) {
        ...
        if (is.nil(aSourceFile)) {
            if (is.nil(aSourceMapConsumer.file)) {
                throw new Error(
    ...
    _validateMapping(aGenerated, aOriginal, aSource, aName) {
        ...
        if (aOriginal && !is.number(aOriginal.line) && !is.number(aOriginal.column)) {
            throw new Error(
