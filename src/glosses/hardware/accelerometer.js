...
const Controllers = {
            ...
            value(opts, dataHandler) {
                ...
                */
                ...
                /*
                  ...
                  0b00000011 = 3 = ±16g
                */
                const range = ({ 2: 0, 4: 1, 8: 2, 16: 3 })[opts.range || 2];
    ...
    MMA8452: {
        ...
        initialize: {
            value(opts, dataHandler) {
                ...
                const odr = rates.indexOf(opts.odr || 800);
                const scale = opts.range || 2;
                const fsr = ({ 2: 0, 4: 1, 8: 2 })[scale];
    ...
    MMA7660: {
        ...
        initialize: {
            value(opts, dataHandler) {
                ...
                this.io.i2cRead(address, this.REGISTER.READREGISTER, READLENGTH, (data) => {
                    dataHandler({
    ...
    LIS3DH: {
        ...
        initialize: {
            value(opts, dataHandler) {
                const state = priv.get(this);
                const address = opts.address || 0x18;
