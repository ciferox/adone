    ...
    MPR121: {
        ...
        initialize: {
            value(opts, dataHandler) {
                ...
                this.io.i2cRead(address, 0x00, 2, (bytes) => {
    ...
    VKEY: {
        initialize: {
            value(opts, dataHandler) {
                ...
                this.io.analogRead(this.pin, (adc) => {
                    dataHandler(adc);
                });
            }
        },
    ...
    AT42QT1070: {
        ...
        initialize: {
            value(opts, dataHandler) {
                ...
                this.io.i2cConfig(opts);
                this.io.i2cRead(address, this.REGISTER.READ, 1, (data) => {
                    dataHandler(data[0]);
                });
            }
        },
    ...
    "3X4_I2C_NANO_BACKPACK": {
        ...
        initialize: {
            value(opts, dataHandler) {
                ...
                this.io.i2cConfig(opts);
                this.io.i2cRead(address, 2, (bytes) => {
