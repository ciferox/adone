...
function Wii(opts) {
    ...
    const data = device.data.bind(this);
    const setup = device.setup;
    const preread = device.preread;
...
Update = {
    ...
    button(isDown) {
        ...
        if (isFireable) {
            ...
            holdTimeout.set(this, setTimeout(() => {
                if (state.isDown) {
                    Change.button.call(this, "hold");
                }
            }, this.controller.holdtime));
