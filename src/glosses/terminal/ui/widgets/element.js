...
export default class Element extends adone.terminal.ui.Node {
    constructor(options = {}) {
        super(options);
        ...
        this.focusable = (is.undefined(options.focusable) ? true : options.focusable); 
        ...
        if (is.number(options.padding) || !options.padding) {
            options.padding = {
    ...
    parseContent(noTags) {
        ...
        if (is.nil(this._clines) || this._clines.width !== width || this._clines.content !== this.content) {
            ...
            if (this.screen.fullUnicode) {
                ...
                if (this.screen.terminal.isiTerm2) {
            ...
            if (!noTags) {
                content = this.screen.terminal.parse(content);
            }
    ...
    key() {
        return this.screen.terminal.key.apply(this, arguments);
    }

    onceKey() {
        return this.screen.terminal.onceKey.apply(this, arguments);
    }

    unkey() {
        return this.screen.terminal.unkey.apply(this, arguments);
    }
    ...
    setLabel(options) {
        ...
        this._label = new adone.terminal.ui.widget.Element({
            screen: this.screen,
            parent: this,
    ...
    // whenever Element.render is called `lpos` gets set on
