...
export default class Prompt extends adone.terminal.ui.widget.Element {
    constructor(options = { }) {
        options.hidden = true;
        super(options);

        this._.input = new adone.terminal.ui.widget.TextBox({
            parent: this,
            top: 3,
            height: 1,
            left: 2,
        ...
        this._.okay = new adone.terminal.ui.widget.Button({
            parent: this,
            top: 5,
            height: 1,
            left: 2,
        ...
        this._.cancel = new adone.terminal.ui.widget.Button({
            parent: this,
            top: 5,
            height: 1,
            shrink: true,
