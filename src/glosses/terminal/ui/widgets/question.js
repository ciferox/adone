...
export default class Question extends adone.terminal.widget.Element {
    constructor(options = { }) {
        options.hidden = true;
        super(options);

        this._.okay = new adone.terminal.widget.Button({
            screen: this.screen,
            parent: this,
            top: 2,
            height: 1,
        ...
        this._.cancel = new adone.terminal.widget.Button({
            screen: this.screen,
            parent: this,
            top: 2,
            height: 1,
