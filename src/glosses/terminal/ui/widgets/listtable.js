...
export default class ListTable extends adone.terminal.ui.widget.List {
    constructor(options = { }) {
        // options.shrink = true;
        ...
        this._header = new adone.terminal.ui.widget.Element({
            parent: this,
...
ListTable.prototype._calculateMaxes = adone.terminal.ui.widget.Table.prototype._calculateMaxes;
