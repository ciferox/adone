...
export default class BigText extends adone.terminal.widget.Element {
    constructor(options = {}) {
        options.font = options.font || `${__dirname}/../../../../../defaults/terminal/fonts/ter-u14n.json`;
        options.fontBold = options.font || `${__dirname}/../../../../../defaults/terminal/fonts/ter-u14b.json`;
        super(options);
