...
export default class SMTPPool extends event.Emitter {
    ...
    close() {
        ...
        const invokeCallbacks = () => {
            ...
            if (entry && is.function(entry.callback)) {
                try {
                    entry.callback(new error.IllegalStateException("Connection pool was closed"));
                } catch (E) {
                    this.logger.error({
                        err: E,
                        tnx: "callback",
     ...
     */
    _createConnection() {
        const connection = new __.PoolResource(this);
    ...
    verify(callback) {
        ...
        const auth = new __.PoolResource(this).auth;
        ...
        this.getSocket(this.options, (err, socketOptions) => {
            ...
            if (socketOptions && socketOptions.connection) {
                ...
                options = __.shared.assign(false, options);
            ...
            connection.once("end", () => {
                ...
                returned = true;
                return callback(new error.IllegalStateException("Connection closed"));
            });
