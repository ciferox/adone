    ...
    var attachments = [].concat(this.mail.attachments || []).map(function (attachment, i) {
        ...
        data = {
            contentType: attachment.contentType ||
                mime.detectMimeType(attachment.filename || attachment.path || attachment.href || "bin"),
    ...
    forEach(function (alternative) {
        ...
        data = {
            contentType: alternative.contentType ||
                mime.detectMimeType(alternative.filename || alternative.path || alternative.href || "txt"),
