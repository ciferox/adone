...
for (i = 0, keys = Object.keys(DISCONNECT_REASON), len = keys.length; i < len;
    ++i) {
...
for (i = 0, keys = Object.keys(CHANNEL_OPEN_FAILURE), len = keys.length; i < len;
    ++i) {
...
if (adone.semver.gte(process.version, "0.11.12")) {
...
if (adone.semver.gte(process.version, "0.11.14")) {
...
if (adone.semver.gte(process.version, "5.2.0")) {
