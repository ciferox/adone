...
export const isIp = (string) => adone.regex.ip({ exact: true }).test(string);
export const isIpv4 = (string) => adone.regex.ip4({ exact: true }).test(string);
export const isIpv6 = (string) => adone.regex.ip6({ exact: true }).test(string);
...
export const address = function (name, family) {
    const interfaces = adone.std.os.networkInterfaces();
