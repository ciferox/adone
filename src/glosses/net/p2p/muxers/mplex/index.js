const {
    net: { p2p: { Connection } },
    event,
    stream: { pull, Duplexify, pump },
    data: { varint },
    is
} = adone;

export const multicodec = "/mplex/6.7.0";
...
export class Multiplex extends adone.std.stream.Duplex {
...
export const listener = (conn) => create(conn, true);
