...
internals.Alternatives = class extends Any {
    ...
    when(condition, options) {
        ...
        assert(isRef(condition) || typeof condition === "string" || (schemaCondition = condition instanceof Any), `Invalid condition: ${condition}`);
        ...
        assert(options.then !== undefined || options.otherwise !== undefined, 'options must have at least one of "then" or "otherwise"');
