adone.lazify({
    ...
    system: () => {
        ...
        switch (process.platform) {
            ...
            default: throw new adone.error.NotSupported(`Unsupported operating system: ${process.platform}`);
        }
    ...
    hardware: () => {
        ...
        switch (process.platform) {
            ...
            default: throw new adone.error.NotSupported(`Unsupported operating system: ${Hardware.platform}`);
        }
        return new Hardware();
    }
