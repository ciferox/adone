adone.lazify({
    native: () => adone.requireAddon(adone.std.path.join(__dirname, "native", "metrics.node")).System,
    ...
    system: () => {
        ...
        switch (process.platform) {
            ...
            default: throw new adone.error.NotSupportedException(`Unsupported operating system: ${process.platform}`);
        }
    ...
    hardware: () => {
        ...
        switch (process.platform) {
            ...
            default: throw new adone.error.NotSupportedException(`Unsupported operating system: ${Hardware.platform}`);
        }
        return new Hardware();
    }
