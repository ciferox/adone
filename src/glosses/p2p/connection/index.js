...
class Connection {
    ...
    constructor({ localAddr, remoteAddr, localPeer, remotePeer, newStream, close, getStreams, stat }) {
        ...
        assert(is.function(newStream), "new stream must be a function");
        assert(is.function(close), "close must be a function");
        assert(is.function(getStreams), "getStreams must be a function");
