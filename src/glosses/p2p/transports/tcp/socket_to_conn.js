...
const toMultiaddr = require("../../utils/ip_port_to_multiaddr");
...
module.exports = (socket, options) => {
    ...
    const maConn = {
            ...
            try {
                await sink((async function* () {
                    for await (const chunk of source) {
                        ...
                        yield is.buffer(chunk) ? chunk : chunk.slice();
                    }
                })());
            } catch (err) {
        ...
        source: options.signal ? abortableIterator(source, options.signal) : source,
