...
class PeerId {
    constructor(id, privKey, pubKey) {
        ...
        assert(is.buffer(id), "invalid id provided");
        ...
        this._id = id;
        this._idB58String = multihash.toB58String(this.id);
    ...
    toHexString() {
        return multihash.toHexString(this.id);
    }
...
const computeDigest = (pubKey) => {
    if (pubKey.bytes.length <= 42) {
        return multihash.encode(pubKey.bytes, "identity");
    }
    return pubKey.hash();
...
exports.createFromHexString = (str) => {
    return new PeerIdWithIs(multihash.fromHexString(str));
};
...
exports.createFromB58String = (str) => {
    return new PeerIdWithIs(multihash.fromB58String(str));
};
...
exports.createFromJSON = async (obj) => {
    const id = multihash.fromB58String(obj.id);
