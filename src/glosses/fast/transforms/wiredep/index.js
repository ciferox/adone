...
const { lazify, vendor, fs, util, std: { path }, is, x, fast: { Fast }, noop } = adone;
...
const mergeFileTypesWithDefaults = (optsFileTypes) => {
    const fileTypes = vendor.lodash.clone(lazy.fileTypesDefault, true);
