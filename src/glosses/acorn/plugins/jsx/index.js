...
module.exports = function (options) {
    ...
    return function (Parser) {
        return plugin({
            ...
            allowNamespacedObjects: Boolean(options.allowNamespacedObjects)
        }, Parser);
    };
};
...
function plugin(options, Parser) {
    return class extends Parser {
        ...
        jsx_parseNamespacedName() {
            const startPos = this.start; const startLoc = this.startLoc;
        ...
        jsx_parseText(value) {
            const node = this.parseLiteral(value);
            node.type = "JSXText";
            return node;
        }
