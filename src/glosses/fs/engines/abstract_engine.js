...
const toUnixTimestamp = (time) => {
    ...
    throw new exception.InvalidArgument(`cannot convert the given argument to a number: ${time}`);
};
...
export class AbstractEngine {
    ...
    async rename(rawOldPath, rawNewPath) {
        ...
        throw new exception.NotSupported("for now cross engine renamings are not supported");
    }
    ...
    async link(rawExistingPath, rawNewPath) {
        ...
        throw new exception.NotSupported("Cross engine hark links are not supported");
    }
