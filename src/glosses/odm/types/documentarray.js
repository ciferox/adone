...
MongooseDocumentArray.mixin = {
    ...
    _cast(value, index) {
        ...
        if (value &&
            ...
            is.string(value[Constructor.schema.options.discriminatorKey]) &&
    ...
    id(id) {
        ...
        try {
            let casted_ = ObjectIdSchema.prototype.cast.call({}, id);
            if (casted_) {
    ...
    create(obj) {
        ...
        if (obj &&
            Constructor.discriminators &&
            Constructor.schema.options.discriminatorKey &&
            is.string(obj[Constructor.schema.options.discriminatorKey]) &&
