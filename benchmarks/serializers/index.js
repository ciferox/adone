...
const dataPath = (name) => adone.std.path.join(__dirname, name);

export const init = async () => {
    jsonData = await adone.fs.readFile(dataPath("data.json"));
    bsonData = await adone.fs.readFile(dataPath("data.bson"));
    mpakData = await adone.fs.readFile(dataPath("data.mpak"));
    json5Data = await adone.fs.readFile(dataPath("data.json5"));
