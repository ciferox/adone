adone.app.run({
    main() {
         ...
         */
        const donut = grid.set(8, 8, 4, 2, adone.terminal.ui.widget.Donut,
            {
                label: "Percent Donut",
                radius: 16,
                arcWidth: 4,
        ...
        const gauge = grid.set(8, 10, 2, 2, adone.terminal.ui.widget.Gauge, { label: "Storage", percent: [80, 20] });
        const gaugeTwo = grid.set(2, 9, 2, 3, adone.terminal.ui.widget.Gauge, { label: "Deployment Progress", percent: 80 });

        const sparkline = grid.set(10, 10, 2, 2, adone.terminal.ui.widget.SparkLine,
            {
        ...
        const bar = grid.set(4, 6, 4, 3, adone.terminal.ui.widget.chart.Bar,
            {
        ...
        const table = grid.set(4, 9, 4, 3, adone.terminal.ui.widget.ExTable,
            {
                keys: true,
                fg: "green",
        ...
        */
        const lcdLineOne = grid.set(0, 9, 2, 3, adone.terminal.ui.widget.LCD,
            {
                label: "LCD Test",
                segmentWidth: 0.06,
        ...
        const errorsLine = grid.set(0, 6, 4, 3, adone.terminal.ui.widget.chart.Line,
            {
                style:
                {
                    line: randomColor(),
        ...
        const transactionsLine = grid.set(0, 0, 6, 6, adone.terminal.ui.widget.chart.Line,
            {
                showNthLabel: 5,
                maxY: 100,
        ...
        const map = grid.set(6, 0, 6, 6, adone.terminal.ui.widget.WorldMap, { label: "Servers Location" });

        const log = grid.set(8, 6, 4, 2, adone.terminal.ui.widget.ExLog,
            {
                fg: randomColor(),
