adone.application.run({
    main() {
        ...
        screen.append(new adone.terminal.ui.widget.Text({
            top: 0,
            left: 2,
            width: "100%",
            //bg: 'blue',
        ...
        screen.append(new adone.terminal.ui.widget.Line({
        ...
        const list = new adone.terminal.ui.widget.List({
            align: "center",
            mouse: true,
            label: " My list ",
            border: "line",
        ...
        const progress = new adone.terminal.ui.widget.ProgressBar({
            border: "line",
            style: {
                fg: "blue",
                bg: "default",
        ...
        const stext = new adone.terminal.ui.widget.ScrollableText({
            //padding: 1,
            mouse: true,
            content: lorem,
            border: "line",
        ...
        const input = new adone.terminal.ui.widget.TextBox({
            label: " My Input ",
            content: "",
            border: "line",
            style: {
        ...
        const button = new adone.terminal.ui.widget.Button({
            //content: 'Click me!',
            content: "Click\nme!",
            shrink: true,
            mouse: true,
