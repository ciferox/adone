adone.app.run({
    main() {
        ...
        const bar = grid.set(4, 6, 4, 3, adone.terminal.ui.widget.BarChart,
            {
        ...
        */
        ...
        const errorsLine = grid.set(0, 6, 4, 3, adone.terminal.ui.widget.LineChart,
            {
                style:
                {
                    line: "red",
        ...
        const transactionsLine = grid.set(0, 0, 6, 6, adone.terminal.ui.widget.LineChart,
            {
                showNthLabel: 5,
                maxY: 100,
