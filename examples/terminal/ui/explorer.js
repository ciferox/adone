...
adone.application.run({
    main() {
        ...
        const grid = new adone.terminal.ui.layout.Grid({ rows: 1, cols: 2, screen });

        const tree = grid.set(0, 0, 1, 1, adone.terminal.ui.widget.Tree,
            {
                style: { text: "red" },
                template: { lines: true },
        ...
        const table = grid.set(0, 1, 1, 1, adone.terminal.ui.widget.ExTable,
            {
                keys: true,
                fg: "green",
                label: "Informations",
